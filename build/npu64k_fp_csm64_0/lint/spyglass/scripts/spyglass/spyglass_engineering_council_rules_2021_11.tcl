...
set_parameter report_cgc_dest_rdc    yes;                       # Enables the Ar_resetcross01 rule to report reset crossings with CGC Latch as a valid RDC destination
...
current_goal rdc/rdc_verify_struct
set_goal_option ignorerules     Ar_resetcross01;
current_goal none
