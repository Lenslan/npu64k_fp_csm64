...
public:
  ...
  template<typename T> void check(T a, T b) {
   ...
   void aot_compile() {
    ...
    dummy_alloc->alloc(czbuf,147456);
    ...
    do {
        coef_tran = cft.read();
        fprintf(outf,"(pix_t)0x%02x,(pix_t)0x%02x,(pix_t)0x%02x,(pix_t)0x%02x,(pix_t)0x%02x,(pix_t)0x%02x,(pix_t)0x%02x,(pix_t)0x%02x,(pix_t)0x%02x,(pix_t)0x%02x,(pix_t)0x%02x,(pix_t)0x%02x,(pix_t)0x%02x,(pix_t)0x%02x,(pix_t)0x%02x,(pix_t)0x%02x,",coef_tran[0]&0xff,coef_tran[1]&0xff,coef_tran[2]&0xff,coef_tran[3]&0xff,coef_tran[4]&0xff,coef_tran[5]&0xff,coef_tran[6]&0xff,coef_tran[7]&0xff,coef_tran[8]&0xff,coef_tran[9]&0xff,coef_tran[10]&0xff,coef_tran[11]&0xff,coef_tran[12]&0xff,coef_tran[13]&0xff,coef_tran[14]&0xff,coef_tran[15]&0xff);
    }while(cft.next());
    fclose(outf);
    #endif
	#ifdef RTL_FAST_SIM
