#ifndef NPU_DHRYSTONE_HPP
#define NPU_DHRYSTONE_HPP
/*
 *************************************************************************
 *
...
/*
 * APH Added to allow for clean exit routine
 */
 char exit_flag;
...
/* constant for power AUX write */
#define AUX_POWER 0x0D0
...
/*
 * APH Added some Reset and IRQ handles
 */


#if 0
_Interrupt2 void halt_handler(void)
{
  asm("mov %r26, 335544499"); /*fail simulation */
#if 0
  _flag(1);
#endif
  _nop();
...
//#pragma off_inline(start_power)
//#pragma off_inline(stop_power)
...
/*
 * APH
 * Finish the simulation and halt the processor
 */
  asm("mov %r26, 1");
  //  asm("mov %r26, 335544497");
#if 0
  _flag(1);
#endif
  _nop();
