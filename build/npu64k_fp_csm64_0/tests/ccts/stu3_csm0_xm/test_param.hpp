...
// size of subtensor to be copied 
 #define XMI_SUB_CHN   32 
#define XMI_SUB_COL    4 
#define XMI_SUB_ROW    1 
#define XMI_SUB_DEP    1 
 
//Actuall XMO transfer 
#define XMO_SUB_CHN   32 
#define XMO_SUB_COL   4 
...
#define SRC_MEM_ALLOC_BASE (0xe8000000 + 0x8000*0)
#define DST_MEM_ALLOC_BASE (0x19000000)
