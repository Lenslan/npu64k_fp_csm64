...
public:
  ...
  void set_sid_ssid(){
    _sr(0x00, 0xF07);       //Select Group0
    _sr(0x00c0ffee, 0xF08); //Set SID
    _sr(0x0c0ffee0, 0xF09); //Set SID
    _sr(0x01, 0xF07);       //Select Group1
    _sr(0xc0ffee00, 0xF08); //Set SID
    _sr(0x0ffee00c, 0xF09); //Set SID
    _sr(0x02, 0xF07);       //Select Group2
    _sr(0xffee00c0, 0xF08); //Set SID
    _sr(0xfee00c0f, 0xF09); //Set SID
    _sr(0x03, 0xF07);       //Select Group3
    _sr(0xee00c0ff, 0xF08); //Set SID
    _sr(0xe00c0ffe, 0xF09); //Set SID
  }
...
void test_program::exec() {
    ...
    if(proc_id == 0 & NPU_HAS_L2ARC) { //l2arc
        cfg_system_map();
        set_sid_ssid();
    ...
    else if((proc_id !=0)  | !NPU_HAS_L2ARC){ //l1arc
