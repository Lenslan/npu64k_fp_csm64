...
module alb_mss_mem
    (input               mss_clk,
     ...
     input   [8-1:0]  mss_mem_cmd_id,
     input   [1-1:0]   mss_mem_cmd_user,
    ...
    localparam alsb = 4;
    // local wires
     wire [1*10-1:0] mss_mem_cfg_lat_w;
     wire [1*10-1:0] mss_mem_cfg_lat_r;
     wire [1-1:0]    mss_mem_perf_awf;
     wire [1-1:0]    mss_mem_perf_arf;
     wire [1-1:0]    mss_mem_perf_aw;
     wire [1-1:0]    mss_mem_perf_ar;
     wire [1-1:0]    mss_mem_perf_w;
     wire [1-1:0]    mss_mem_perf_wl;
     wire [1-1:0]    mss_mem_perf_r;
     wire [1-1:0]    mss_mem_perf_rl;
     wire [1-1:0]    mss_mem_perf_b;

    assign mss_mem_cfg_lat_w = {1*10{1'b0}};
    assign mss_mem_cfg_lat_r = {1*10{1'b0}};
    wire               i_mem_clk;
 ...
 wire [3 * 1 -1:0] splt_i_ibp_wrsp_chnl;
    ...
    wire  [1-1:0]    splt_i_cmd_chnl_user;
 ...
 wire [3 * 1 -1:0] splt_o_bus_ibp_wrsp_chnl;
    ...
    wire [1*1-1:0]    splt_o_bus_ibp_cmd_chnl_user;
 ...
 wire [3 * 1 -1:0] split_0_ibp_wrsp_chnl;
    ...
    wire [1-1:0]    split_0_ibp_cmd_chnl_user;
  ...
  wire                                  split_0_ibp_wr_resp_accept;
    wire [1-1:0]    split_0_ibp_cmd_user;
  ...
  wire                                  lat_o_rgon0_ibp_wr_resp_accept;
    wire [1-1:0]    lat_o_rgon0_ibp_cmd_user;
  ...
  wire                                  pre_byp_rgon0_ibp_wr_resp_accept;
    wire [1-1:0]    pre_byp_rgon0_ibp_cmd_user;
 ...
 wire [3 * 1 -1:0] pre_byp_rgon0_ibp_wrsp_chnl;
    ...
    wire [1-1:0]    pre_byp_rgon0_ibp_cmd_chnl_user;
 ...
 wire [3 * 1 -1:0] pre_bind_rgon0_ibp_wrsp_chnl;
    ...
    wire [1-1:0]    pre_bind_rgon0_ibp_cmd_chnl_user;
  ...
  wire                                  bind_rgon0_ibp_wr_resp_accept;
    wire [1-1:0]    bind_rgon0_ibp_cmd_user;
 ...
 wire [3 * 1 -1:0] bind_rgon0_ibp_wrsp_chnl;
    ...
    wire [1-1:0]    bind_rgon0_ibp_cmd_chnl_user;
  ...
  .ibp_wr_resp_accept        (split_0_ibp_wr_resp_accept),
    ...
    alb_mss_mem_ibp_lat #(.a_w(32),
                      .d_w(128),
                      .u_w(1),
                      .depl2(7)) u_rgon0_lat_inst(.clk(mss_clk),
                                                 .clk_en(1'b1),
                                                 .rst_b(rst_b),
