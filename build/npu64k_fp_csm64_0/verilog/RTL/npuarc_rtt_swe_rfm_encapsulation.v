...
//  such as:
//
//   vpp +q +o rtt_swe_rfm_encapsulation.vpp
//
// ===========================================================================
...
module npuarc_rtt_swe_rfm_encapsulation (
...
assign rf_msg_valid = rfm_en && rtt_time_stamp_en && (&time_stamp);
assign rcode = 4'b1000;
assign rdata = 32'h0;
...
assign rfm_mseo[3] = ~|rcode[2:0] ? 2'b00 : (~|rdata[31:14] ? 2'b11 : (~|rdata[31:22] ? 2'b01 : 2'b00));
assign rfm_mseo[4] = ~|rcode[2:0] ? 2'b00 : (~|rdata[31:22] ? 2'b11 : (~|rdata[31:30] ? 2'b01 : 2'b00));
assign rfm_mseo[5] = ~|rcode[2:0] ? 2'b00 : (~|rdata[31:30] ? 2'b11 : 2'b01);
assign rfm_mseo[6] = ~|rcode[2:0] ? 2'b00 : (~|rdata[31:30] ? 2'b00 : 2'b11);
