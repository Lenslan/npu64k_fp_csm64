...
`define    MMU_PD1_ECC_TOTAL_WIDTH    45
`define    MMU_PD1_ECC_TOTAL_RANGE    44:0
`define    MMU_PD1_ECC_CHKBIT_WIDTH   7
`define    MMU_PD1_ECC_CHKBIT_RANGE   44:38

// This function returns the check bits
function automatic [6:0] mmu_pd1_ecc_enc;
    input [37:0] data_in;
...
begin
    ...
    edc_tmp[0] = ^(word_in & 38'b10101010101011010101010101010101011011);
    edc_tmp[1] = ^(word_in & 38'b00110011001101100110011001101001101101);
    edc_tmp[2] = ^(word_in & 38'b11000011110001111000011110001110001110);
    edc_tmp[3] = ^(word_in & 38'b11111100000001111111100000001111110000);
    edc_tmp[4] = ^(word_in & 38'b00000000000001111111111111110000000000);
    edc_tmp[5] = ^(word_in & 38'b11111111111110000000000000000000000000);
...
function automatic [6:0] mmu_pd1_ecc_dec_a;
    input [37:0] data_in;
    input [6 :0] ecc_in;
...
begin
    ...
    calc_edc[0] = ^(word_in & 38'b10101010101011010101010101010101011011);
    calc_edc[1] = ^(word_in & 38'b00110011001101100110011001101001101101);
    calc_edc[2] = ^(word_in & 38'b11000011110001111000011110001110001110);
    calc_edc[3] = ^(word_in & 38'b11111100000001111111100000001111110000);
    calc_edc[4] = ^(word_in & 38'b00000000000001111111111111110000000000);
    calc_edc[5] = ^(word_in & 38'b11111111111110000000000000000000000000);
    ...
    mmu_pd1_ecc_dec_a = {overall_parity, syndrome};
end
endfunction


// This function returns the {unknown_err, double_err, single_err};
function automatic [2:0] mmu_pd1_ecc_dec_b;
    input enable;
    input [5:0] syndrome;
...
// Checks if the syndrome is unused syndrome
    is_unused_syndrome = (syndrome == 15) | (syndrome == 46) | (syndrome == 47) | (syndrome == 48) | (syndrome == 49) | (syndrome == 50) | 
    ...
    mmu_pd1_ecc_dec_b = {unknown_err, double_err, single_err};
end
endfunction


// This function returns the corrected data;
function automatic [37:0] mmu_pd1_ecc_dec_c;
    input single_err;
    input [5:0] syndrome;
    input [37:0] data_in;
    reg [37:0] data_out;
begin
    ...
    mmu_pd1_ecc_dec_c = data_out;
end
endfunction


// This function returns the corrected ecc code;
function automatic [6 :0] mmu_pd1_ecc_dec_d;
    input single_err;
    input [5:0] syndrome;
    input [6 :0] ecc_in;
    reg [6 :0] ecc_out;
