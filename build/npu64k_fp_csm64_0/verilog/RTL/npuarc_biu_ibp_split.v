...
genvar i;
generate //{
  if((SPLT_NUM == 1) || (SPLT_FIFO_DEPTH == 0)) begin:split_num_eq_1_gen// {
    ...
    wire [SPLT_NUM-1:0] o_wd_chnl_last;
...
// SJ:  this Convergence logic is related to level 1 clock gate, not care
    ...
    // LMD: Out Of Range Index
    // LJ:  The id_ptr is generated correctly, so never get out of range
...
// spyglass enable_block Ac_conv01
    ...
    reg [SPLT_FIFO_WIDTH-1:0] indicator_idx;
    always @ (*) begin : i_split_indicator_id_PROC
      i_split_indicator_id = {SPLT_FIFO_WIDTH{1'b0}};
      for(j = 0; j < SPLT_NUM; j = j+1) begin//{
        indicator_idx = j;
        i_split_indicator_id = i_split_indicator_id | {SPLT_FIFO_WIDTH{i_ibp_split_indicator[j]}} & indicator_idx;
      end//}
    end
    ...
    wire wd_chnl_fifo_ren_raw_golden = i_ibp_wd_chnl_hashked;
    wire wd_chnl_fifo_ren_raw = | (o_bus_ibp_wd_chnl_valid & o_bus_ibp_wd_chnl_accept & o_wd_chnl_last);
...
wire [SPLT_FIFO_DEPTH:0] unuse_wd_splt_info_i_occp;
wire [SPLT_FIFO_DEPTH:0] unuse_wd_splt_info_o_occp;
wire [SPLT_FIFO_DEPTH:0] unuse_rd_splt_info_i_occp;
wire [SPLT_FIFO_DEPTH:0] unuse_rd_splt_info_o_occp;
wire [SPLT_FIFO_DEPTH:0] unuse_wrsp_splt_info_i_occp;
wire [SPLT_FIFO_DEPTH:0] unuse_wrsp_splt_info_o_occp;
...
// SJ:This signal is unused
      .i_occp    (unuse_wd_splt_info_i_occp),
      .o_occp    (unuse_wd_splt_info_o_occp),
...
// SMD: Connected to floating net
// SJ:This signal is unused
      .i_occp    (unuse_rd_splt_info_i_occp),
      .o_occp    (unuse_rd_splt_info_o_occp),
// spyglass enable_block UnloadedOutTerm-ML
// spyglass enable_block W287b
      // leda B_1011 on
      // leda WV951025 on
...
// SMD: Instance input port is not connected
// SJ: There is dirving for this port
...
// SMD: Connected to floating net
// SJ:This signal is unused
      .i_occp    (unuse_wrsp_splt_info_i_occp),
      .o_occp    (unuse_wrsp_splt_info_o_occp),
// spyglass enable_block UnloadedOutTerm-ML
// spyglass enable_block W287b
      // leda B_1011 on
      // leda WV951025 on
    ...
    begin:o_wd_chnl_valid_gen
     ...
     assign o_wd_chnl_last[i] = i_ibp_wd_chnl[WD_CHNL_LAST];
    end//}
    //
