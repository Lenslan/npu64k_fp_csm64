...
module npuarc_alb_ifu_fetch_if_fifo 
  ( 
  input                    clk,
  input                    rst_a,
  input                    restart,
  ...
  input [46:0]     wdata,
  input                        rd,
  output reg [46:0]    rdata,
  output [46:46] rdata_flop,
// leda NTL_CON32 off
...
begin: fifo_regs_nxt_PROC
  if (restart) begin
    ...
    if (wr == 1'b1) begin
      cnt_nxt_tmp = { {(1){1'b0}}, 1'b1};
      empty_nxt_tmp = 1'b0;
      full_nxt_tmp = (1 == 1);
    end
    else begin  
      cnt_nxt_tmp = {(1+1){1'b0}};
      empty_nxt_tmp = 1'b1;
      full_nxt_tmp = 1'b0;
    end
  end
...
begin: fifo_mem_rd_nxt_PROC
  if (wr && (cnt_nxt == { {1{1'b0}}, 1'b1 })) begin //bypass input
    rdata_r_nxt = wdata[46: 46]; 
  end
  else begin
    rdata_r_nxt = rdata_erly[46: 46]; 
  end
end //block: fifo_mem_PROC
...
assign rdata_flop = {(46-46+1){1'b0}}; 
// leda NTL_RST03 on
// leda FM_2_22 on
// leda S_1C_R on
