...
module npuarc_alb_maskgen (
  ...
  //
  output reg  [`npuarc_DATA_RANGE] mask_result   // output is either a bit mask
...
reg     [`npuarc_DATA_RANGE]       one_hot;      // one-hot decoding of src2[4:0]
reg     [`npuarc_DATA_RANGE]       bit_mask;     // mask decoding of src2[4:0]
