...
//  such as:
//
//   vpp +q +o rtt_swe_cstm_encapsulation.vpp
//
// ===========================================================================

`include "npuarc_arc_rtt_defines.v"
`include "npuarc_rtt_pkg_defines.v"
module npuarc_rtt_swe_cstm_encapsulation (
cstm_en,
p0_csts_en,
atb_syncreq,
resource_full,
...
assign cst_msg_valid =  cstm_en && p0_csts_en && ((resource_full && (rfm_rcode==4'b1000)) || atb_syncreq);
