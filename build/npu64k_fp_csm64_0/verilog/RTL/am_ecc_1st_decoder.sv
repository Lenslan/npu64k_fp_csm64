...
//prefix: am_ecc_1st_ ALL_ZERO_ALL_ON:1 SECDED:1 PIPELINE:0 OVERWRITE_PREFIX:am_ecc_1st_ generic:0
module am_ecc_1st_decoder(
...
assign data_out = am_ecc_1st_dec_c(
      overall_parity_and_enable
    , syndrome
    , data_in
    );

assign ecc_out = am_ecc_1st_dec_d(
      overall_parity_and_enable
    , syndrome
    , ecc_in
    );
