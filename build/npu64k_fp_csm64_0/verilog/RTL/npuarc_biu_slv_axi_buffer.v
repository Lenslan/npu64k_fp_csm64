...
module npuarc_biu_slv_axi_buffer
  #(
...
wire [CHNL_FIFO_DEPTH:0] unuse_axi_ar_i_occp;
wire [CHNL_FIFO_DEPTH:0] unuse_axi_ar_o_occp;
npuarc_biu_fifo #(
...
// LJ: unused in this instantiation
  .i_occp    (unuse_axi_ar_i_occp),
  .o_occp    (unuse_axi_ar_o_occp),
// leda B_1011 on
// leda WV951025 on
...
wire [CHNL_FIFO_DEPTH:0] unuse_axi_aw_i_occp;
wire [CHNL_FIFO_DEPTH:0] unuse_axi_aw_o_occp;
...
// LMD: Port is not completely connected
// LJ: unused in this instantiation
  .i_occp    (unuse_axi_aw_i_occp),
  .o_occp    (unuse_axi_aw_o_occp),
// leda B_1011 on
// leda WV951025 on
// spyglass enable_block W287b
...
//
wire [CHNL_FIFO_DEPTH:0] unuse_axi_wdata_i_occp;
wire [CHNL_FIFO_DEPTH:0] unuse_axi_wdata_o_occp;
npuarc_biu_fifo # (
  .FIFO_DEPTH(CHNL_FIFO_DEPTH),
  .FIFO_WIDTH(W_CHNL_W),
  .IN_OUT_MWHILE (0),
...
// LMD: Port is not completely connected
// LJ: unused in this instantiation
  .i_occp    (unuse_axi_wdata_i_occp),
  .o_occp    (unuse_axi_wdata_o_occp),
// leda B_1011 on
// leda WV951025 on
// spyglass enable_block W287b
...
wire [CHNL_FIFO_DEPTH:0] unuse_axi_rdata_i_occp;
wire [CHNL_FIFO_DEPTH:0] unuse_axi_rdata_o_occp;
...
// LMD: Port is not completely connected
// LJ: unused in this instantiation
  .i_occp    (unuse_axi_rdata_i_occp),
  .o_occp    (unuse_axi_rdata_o_occp),
// leda B_1011 on
// leda WV951025 on
// spyglass enable_block W287b
...
wire [CHNL_FIFO_DEPTH:0] unuse_axi_bresp_i_occp;
wire [CHNL_FIFO_DEPTH:0] unuse_axi_bresp_o_occp;
npuarc_biu_fifo #(
  .FIFO_DEPTH(CHNL_FIFO_DEPTH),
  .FIFO_WIDTH(B_CHNL_W),
  .IN_OUT_MWHILE (0),
...
// LMD: Port is not completely connected
// LJ: unused in this instantiation
  .i_occp    (unuse_axi_bresp_i_occp),
  .o_occp    (unuse_axi_bresp_o_occp),
// leda B_1011 on
// leda WV951025 on
// spyglass enable_block W287b
