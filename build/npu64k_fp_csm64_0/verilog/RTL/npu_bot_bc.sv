...
module npu_bot_bc
  ...
  typedef  logic [AXIIDW-1:0] id_t;
    ...
    assign    axi_slv_arsyn_flg[0]  = axi_slv_aruser[0][68+:4];
    assign    axi_slv_arsyn_flg[1]  = axi_slv_aruser[1][68+:4];
    assign    axi_slv_arsyn_flg[2]  = axi_slv_aruser[2][68+:4];
    assign    axi_slv_arsyn_flg[3]  = axi_slv_aruser[3][68+:4];
