...
module npuarc_biu_preprc_ibp_buffer
  #(
...
wire [CMD_CHNL_W+RGON_W+USER_W+ID_W-1:0] cmd_chnl_fifo_i_data ;
wire [CMD_CHNL_W+RGON_W+USER_W+ID_W-1:0] cmd_chnl_fifo_o_data ;
...
wire [CMD_CHNL_FIFO_DEPTH:0] unuse_cmd_chnl_fifo_i_occp;
wire [CMD_CHNL_FIFO_DEPTH:0] unuse_cmd_chnl_fifo_o_occp;
npuarc_biu_preprc_fifo # (
  .FIFO_DEPTH(CMD_CHNL_FIFO_DEPTH),
  .FIFO_WIDTH((CMD_CHNL_W + RGON_W + USER_W + ID_W)),
...
// SMD: Instance output port is not connected
// SJ: No care about the warning
  .i_occp    (unuse_cmd_chnl_fifo_i_occp),
  .o_occp    (unuse_cmd_chnl_fifo_o_occp),
// spyglass enable_block W287b
...
wire [WD_CHNL_W+ID_W-1:0] wdata_chnl_fifo_i_data =
                                         {i_ibp_wd_chnl
                                          }
                                         ;
// The FIFO is read as o_ibp_wd_chnl
wire [WD_CHNL_W+ID_W-1:0] wdata_chnl_fifo_o_data;
assign {o_ibp_wd_chnl
       }
      = wdata_chnl_fifo_o_data;
...
endgenerate
//
wire [WDATA_CHNL_FIFO_DEPTH:0] unuse_wdata_chnl_fifo_i_occp;
wire [WDATA_CHNL_FIFO_DEPTH:0] unuse_wdata_chnl_fifo_o_occp;

npuarc_biu_preprc_fifo # (
  .FIFO_DEPTH(WDATA_CHNL_FIFO_DEPTH),
  .FIFO_WIDTH(WD_CHNL_W+ID_W),
...
// SMD: Instance output port is not connected
// SJ: No care about the warning
  .i_occp    (unuse_wdata_chnl_fifo_i_occp),
  .o_occp    (unuse_wdata_chnl_fifo_o_occp),
// spyglass enable_block W287b
// spyglass enable_block UnloadedOutTerm-ML
// leda B_1011 on
// leda WV951025 on
...
wire [RD_CHNL_W+ID_W-1:0] rdata_chnl_fifo_i_data =
                                                {o_ibp_rd_chnl
                                                };
// The FIFO is read as i_ibp_rd_chnl
wire [RD_CHNL_W+ID_W-1:0] rdata_chnl_fifo_o_data;
assign {i_ibp_rd_chnl
       }
                      = rdata_chnl_fifo_o_data
                      ;
...
endgenerate
//
wire [RDATA_CHNL_FIFO_DEPTH:0] unuse_rdata_chnl_fifo_i_occp;
wire [RDATA_CHNL_FIFO_DEPTH:0] unuse_rdata_chnl_fifo_o_occp;
npuarc_biu_preprc_fifo # (
  .FIFO_DEPTH(RDATA_CHNL_FIFO_DEPTH),
  .FIFO_WIDTH(RD_CHNL_W+ID_W),
...
// SMD: Instance output port is not connected
// SJ: No care about the warning
  .i_occp    (unuse_rdata_chnl_fifo_i_occp),
  .o_occp    (unuse_rdata_chnl_fifo_o_occp),
// spyglass enable_block W287b
// spyglass enable_block UnloadedOutTerm-ML
// leda B_1011 on
// leda WV951025 on
...
wire [WRSP_CHNL_W+ID_W-1:0] wresp_chnl_fifo_i_data ;
wire [WRSP_CHNL_W+ID_W-1:0] wresp_chnl_fifo_o_data ;

assign wresp_chnl_fifo_i_data =
                              {o_ibp_wrsp_chnl
                              };
assign {i_ibp_wrsp_chnl
       }
                              = wresp_chnl_fifo_o_data;

wire [WRESP_CHNL_FIFO_DEPTH:0] unuse_wresp_chnl_fifo_i_occp;
wire [WRESP_CHNL_FIFO_DEPTH:0] unuse_wresp_chnl_fifo_o_occp;
npuarc_biu_preprc_fifo # (
  .FIFO_DEPTH(WRESP_CHNL_FIFO_DEPTH),
  .FIFO_WIDTH(WRSP_CHNL_W+ID_W),
...
// SMD: Instance output port is not connected
// SJ: No care about the warning
  .i_occp    (unuse_wresp_chnl_fifo_i_occp),
  .o_occp    (unuse_wresp_chnl_fifo_o_occp),
// spyglass enable_block W287b
// spyglass enable_block UnloadedOutTerm-ML
// leda B_1011 on
// leda WV951025 on
...
wire [OUTSTAND_CNT_W:0] cmd_wait_wd_cnt_nxt =
      ( cmd_wait_wd_cnt_inc ) ? (cmd_wait_wd_cnt_r + 1'b1) : (cmd_wait_wd_cnt_r - 1'b1);
// leda B_3219 on
// leda B_3200 on
// leda W484 on
// leda BTTF_D002 on
...
// SMD:  the enable signal for the flip-flop is always zero
// SJ: no impact.
...
wire [OUTSTAND_CNT_W:0] o_cmd_wait_wd_cnt_nxt =
      ( o_cmd_wait_wd_cnt_inc ) ? (o_cmd_wait_wd_cnt_r + 1'b1) : (o_cmd_wait_wd_cnt_r - 1'b1);
// leda B_3219 on
// leda B_3200 on
// leda W484 on
// leda BTTF_D002 on
...
wire [OUTSTAND_CNT_W:0] out_wr_cmd_cnt_nxt =
      ( out_wr_cmd_cnt_inc ) ? (out_wr_cmd_cnt_r + 1'b1) : (out_wr_cmd_cnt_r - 1'b1);
// leda B_3219 on
// leda B_3200 on
// leda W484 on
// leda BTTF_D002 on
...
//      is not gated, its clock runs every other core clock
...
wire [OUTSTAND_CNT_W:0] out_rd_cmd_cnt_nxt =
      ( out_rd_cmd_cnt_inc ) ? (out_rd_cmd_cnt_r + 1'b1) : (out_rd_cmd_cnt_r - 1'b1);
// leda B_3219 on
// leda B_3200 on
// leda W484 on
// leda BTTF_D002 on
...
endmodule // biu_preprc_ibp_buffer
