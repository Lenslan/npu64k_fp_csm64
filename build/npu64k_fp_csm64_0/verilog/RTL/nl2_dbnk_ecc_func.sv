...
`define    DBNK_ECC_TOTAL_WIDTH    137
`define    DBNK_ECC_TOTAL_RANGE    136:0
`define    DBNK_ECC_CHKBIT_WIDTH   9
`define    DBNK_ECC_CHKBIT_RANGE   136:128

// This function returns the check bits
function automatic [8:0] dbnk_ecc_enc;
    input [127:0] data_in;
...
function automatic [8:0] dbnk_ecc_dec_a;
    input [127:0] data_in;
    input [8 :0] ecc_in;
...
begin
    ...
    dbnk_ecc_dec_a = {overall_parity, syndrome};
end
endfunction


// This function returns the {unknown_err, double_err, single_err};
function automatic [2:0] dbnk_ecc_dec_b;
    input enable;
    input [7:0] syndrome;
...
// Checks if the syndrome is unused syndrome
    ...
    dbnk_ecc_dec_b = {unknown_err, double_err, single_err};
end
endfunction


// This function returns the corrected data;
function automatic [127:0] dbnk_ecc_dec_c;
    input single_err;
    input [7:0] syndrome;
    input [127:0] data_in;
    reg [127:0] data_out;
begin
    ...
    dbnk_ecc_dec_c = data_out;
end
endfunction


// This function returns the corrected ecc code;
function automatic [8 :0] dbnk_ecc_dec_d;
    input single_err;
    input [7:0] syndrome;
    input [8 :0] ecc_in;
    reg [8 :0] ecc_out;
