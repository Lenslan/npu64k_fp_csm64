...
// One bank of a NPU vector memory
...
// spyglass enable_block W240
    ...
    // Memory macro
    `Mem_npu_vec_bank u_npu_mem_vec_bank_macro (
        .ME(mem_en),
        .Q(rd_data),
        .D(wr_data),
        .ADR(addr),
