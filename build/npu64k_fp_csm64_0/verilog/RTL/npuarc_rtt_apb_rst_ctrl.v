...
//
// Description:
//  The rtt_apb_rst_ctrl module provides synchronous deassertion of the
...
// SMD: Asynchronous reset signal 'pd1_rst_a' is synchronized at least twice
// SJ:  Synchronize the pd1_rst_a is OK

// spyglass disable_block Ac_unsync01
// SMD: Unsynchronized Crossing
// SJ:  mcip_clk and clk are the same clock
...
module npuarc_rtt_apb_rst_ctrl (
input  clk,            // clock
...
assign rsts_a = rst_in;

npuarc_rtt_cdc_sync u_apb_rst_cdc_sync_r (
                                   .clk   (clk),
                                   .rst_a (rst_a),
                                   .din   (rsts_a),
                                   .dout  (rst_n)
...
assign rst_out = test_mode ? rst_in : rst_n;
