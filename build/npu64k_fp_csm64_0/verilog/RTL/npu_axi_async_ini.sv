...
// Initiator part of AXI async bridge
...
module npu_axi_async_ini
  ...
  (
   ...
   // AXI master async interface
   `AXIASYNCMST(AXIIDW,AXIDW,AXIAWUW,AXIWUW,AXIBUW,AXIARUW,AXIRUW,AWFIFO_DEPTHL2,WFIFO_DEPTHL2,BFIFO_DEPTHL2,ARFIFO_DEPTHL2,RFIFO_DEPTHL2,axi_async_mst_)
   );
  // type definitions
  ...
  assign axi_async_mst_clk_req = clk_req_r;
  assign clk_req_nxt           = {r_val_r, b_val_r, wpend_r} != '0;
...
// spyglass enable_block SelfDeterminedExpr-ML
  ...
  (
   ...
   .rdpnt          ( axi_async_mst_aw_rdpnt  ),
   .rdata          ( axi_async_mst_aw_data   ),
   .wpnt           ( axi_async_mst_aw_wpnt   ),
   .rpnt_a         ( axi_async_mst_aw_rpnt_a )
  );
  ...
  (
   ...
   .rdpnt          ( axi_async_mst_w_rdpnt  ),
   .rdata          ( axi_async_mst_w_data   ),
   .wpnt           ( axi_async_mst_w_wpnt   ),
   .rpnt_a         ( axi_async_mst_w_rpnt_a )
  );
  ...
  (
   ...
   .rdpnt         ( axi_async_mst_b_rdpnt  ),
   .rdata         ( axi_async_mst_b_data   ),
   .wpnt_a        ( axi_async_mst_b_wpnt_a ),
   .rpnt          ( axi_async_mst_b_rpnt   )
  );
  ...
  (
   ...
   .rdpnt          ( axi_async_mst_ar_rdpnt  ),
   .rdata          ( axi_async_mst_ar_data   ),
   .wpnt           ( axi_async_mst_ar_wpnt   ),
   .rpnt_a         ( axi_async_mst_ar_rpnt_a )
  );
  ...
  (
   ...
   .rdpnt         ( axi_async_mst_r_rdpnt  ),
   .rdata         ( axi_async_mst_r_data   ),
   .wpnt_a        ( axi_async_mst_r_wpnt_a ),
   .rpnt          ( axi_async_mst_r_rpnt   )
  );


endmodule : npu_axi_async_ini
