...
// Revision    : $Id: //dwh/DW_ocb/DW_axi_gs/amba_dev/src/DW_axi_gs_bcm06.v#10 $
// Author      : Rick Kelly          04/14/04
// Description : DW_axi_gs_bcm06.v Verilog module for DW_axi_gs
//
// DesignWare IP ID: c7a15259
//
////////////////////////////////////////////////////////////////////////////////

module arcsync_bus_gs_DW_axi_gs_bcm06 (
    clk,
    rst_n,
    init_n,
    push_req_n,
...
`ifndef SYNTHESIS
  ...
  DW_axi_gs_sva12_b P_RESET_PUSH(
    .clk(clk),
    .rst_n(rst_n),
    .init_n(init_n),
    .req_n(push_req_n)
