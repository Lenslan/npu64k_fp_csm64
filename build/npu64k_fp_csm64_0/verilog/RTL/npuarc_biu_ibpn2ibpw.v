...
wire [SPLT_FIFO_DEPTH:0] unuse_wd_lane_vec_i_occp;
wire [SPLT_FIFO_DEPTH:0] unuse_wd_lane_vec_o_occp;
...
// SJ: No care about the warning
  .i_occp    (unuse_wd_lane_vec_i_occp),
  .o_occp    (unuse_wd_lane_vec_o_occp),
...
wire [SPLT_FIFO_DEPTH:0] unuse_rd_lane_vec_i_occp;
wire [SPLT_FIFO_DEPTH:0] unuse_rd_lane_vec_o_occp;
...
// SMD: port not connected
// SJ: No care about the warning
  .i_occp    (unuse_rd_lane_vec_i_occp),
  .o_occp    (unuse_rd_lane_vec_o_occp),
// spyglass enable_block W287b
  // leda B_1011 on
  // leda WV951025 on
  .clk       (clk  ),
