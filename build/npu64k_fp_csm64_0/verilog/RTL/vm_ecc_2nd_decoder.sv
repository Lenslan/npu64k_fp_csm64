...
//prefix: vm_ecc_2nd_ ALL_ZERO_ALL_ON:1 SECDED:1 PIPELINE:0 OVERWRITE_PREFIX:vm_ecc_2nd_ generic:0
module vm_ecc_2nd_decoder(
...
assign data_out = vm_ecc_2nd_dec_c(
      overall_parity_and_enable
    , syndrome
    , data_in
    );

assign ecc_out = vm_ecc_2nd_dec_d(
      overall_parity_and_enable
    , syndrome
    , ecc_in
    );
