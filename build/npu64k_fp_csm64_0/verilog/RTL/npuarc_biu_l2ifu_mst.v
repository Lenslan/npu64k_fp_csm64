...
//
// Description:
//  Verilog module of biu_l2ifu master port
//
// ===========================================================================
...
// LJ: Pfx may include the uppercase, so disable the lint checking rule
  ...
  output                                  bfed_core0_nllm_l2ifu_ibp_cmd_valid,
  input                                   bfed_core0_nllm_l2ifu_ibp_cmd_accept,
  output                                  bfed_core0_nllm_l2ifu_ibp_cmd_read,
  output  [40                -1:0]       bfed_core0_nllm_l2ifu_ibp_cmd_addr,
  output                                  bfed_core0_nllm_l2ifu_ibp_cmd_wrap,
  output  [3-1:0]       bfed_core0_nllm_l2ifu_ibp_cmd_data_size,
  output  [4-1:0]       bfed_core0_nllm_l2ifu_ibp_cmd_burst_size,
  output  [2-1:0]       bfed_core0_nllm_l2ifu_ibp_cmd_prot,
  output  [4-1:0]       bfed_core0_nllm_l2ifu_ibp_cmd_cache,
  output                                  bfed_core0_nllm_l2ifu_ibp_cmd_lock,
  output                                  bfed_core0_nllm_l2ifu_ibp_cmd_excl,

  input                                   bfed_core0_nllm_l2ifu_ibp_rd_valid,
  input                                   bfed_core0_nllm_l2ifu_ibp_rd_excl_ok,
  output                                  bfed_core0_nllm_l2ifu_ibp_rd_accept,
  input                                   bfed_core0_nllm_l2ifu_ibp_err_rd,
  input   [64               -1:0]        bfed_core0_nllm_l2ifu_ibp_rd_data,
  input                                   bfed_core0_nllm_l2ifu_ibp_rd_last,

  output                                  bfed_core0_nllm_l2ifu_ibp_wr_valid,
  input                                   bfed_core0_nllm_l2ifu_ibp_wr_accept,
  output  [64               -1:0]        bfed_core0_nllm_l2ifu_ibp_wr_data,
  output  [8  -1:0]                    bfed_core0_nllm_l2ifu_ibp_wr_mask,
  output                                  bfed_core0_nllm_l2ifu_ibp_wr_last,
  ...
  output                                  bfed_core0_nllm_l2ifu_ibp_wr_resp_accept,
  input                                  clk,
...
// Pack all the IBP buses
 ...
 wire [3 * 1 -1:0] bfed_ifu_merg_ibp_wrsp_chnl;
    ...
    wire [1-1:0] bfed_ifu_merg_ibp_cmd_user = {1{1'b0}};
    wire [1-1:0] bfed_ifu_merg_ibp_cmd_chnl_user;

// Declare unused ports
// spyglass disable_block W240
// SMD: An input has been declared but is not read
// SJ: Unused instance ports are port-mapped but not connected
wire unused_bfed_ifu_merg_ibp_cmd_chnl_rgon;
...
u_bfed_ifu_merg_ibp2pack
  ...
  .ibp_wr_resp_accept        (bfed_ifu_merg_ibp_wr_resp_accept),
    ...
    .ibp_cmd_rgon              (1'b1),
    .ibp_cmd_user              (bfed_ifu_merg_ibp_cmd_user),




    .ibp_cmd_chnl_valid  (bfed_ifu_merg_ibp_cmd_chnl_valid),
    .ibp_cmd_chnl_accept (bfed_ifu_merg_ibp_cmd_chnl_accept),
    .ibp_cmd_chnl        (bfed_ifu_merg_ibp_cmd_chnl),

    .ibp_rd_chnl_valid   (bfed_ifu_merg_ibp_rd_chnl_valid),
    .ibp_rd_chnl_accept  (bfed_ifu_merg_ibp_rd_chnl_accept),
    .ibp_rd_chnl         (bfed_ifu_merg_ibp_rd_chnl),

    .ibp_wd_chnl_valid   (bfed_ifu_merg_ibp_wd_chnl_valid),
    .ibp_wd_chnl_accept  (bfed_ifu_merg_ibp_wd_chnl_accept),
    .ibp_wd_chnl         (bfed_ifu_merg_ibp_wd_chnl),

    .ibp_wrsp_chnl_valid (bfed_ifu_merg_ibp_wrsp_chnl_valid),
    .ibp_wrsp_chnl_accept(bfed_ifu_merg_ibp_wrsp_chnl_accept),
    .ibp_wrsp_chnl       (bfed_ifu_merg_ibp_wrsp_chnl),
...
// SJ: do not care this wrn
    .ibp_cmd_chnl_rgon         (unused_bfed_ifu_merg_ibp_cmd_chnl_rgon),
// spyglass enable_block UnloadedOutTerm-ML
    .ibp_cmd_chnl_user         (bfed_ifu_merg_ibp_cmd_chnl_user)
// leda B_1011 on
// leda WV951025 on
...
// leda NTL_CON10B on
 ...
 wire [1-1:0] bfed_ifu_merg_bfed_ibp_cmd_chnl_valid;
 wire [1-1:0] bfed_ifu_merg_bfed_ibp_cmd_chnl_accept;
 wire [57 * 1 -1:0] bfed_ifu_merg_bfed_ibp_cmd_chnl;

 wire [1-1:0] bfed_ifu_merg_bfed_ibp_wd_chnl_valid;
 wire [1-1:0] bfed_ifu_merg_bfed_ibp_wd_chnl_accept;
 wire [73 * 1 -1:0] bfed_ifu_merg_bfed_ibp_wd_chnl;

 wire [1-1:0] bfed_ifu_merg_bfed_ibp_rd_chnl_accept;
 wire [1-1:0] bfed_ifu_merg_bfed_ibp_rd_chnl_valid;
 wire [67 * 1 -1:0] bfed_ifu_merg_bfed_ibp_rd_chnl;

 wire [1-1:0] bfed_ifu_merg_bfed_ibp_wrsp_chnl_valid;
 wire [1-1:0] bfed_ifu_merg_bfed_ibp_wrsp_chnl_accept;
 wire [3 * 1 -1:0] bfed_ifu_merg_bfed_ibp_wrsp_chnl;

wire [1-1:0] bfed_ifu_merg_bfed_ibp_cmd_chnl_user;


  assign bfed_ifu_merg_bfed_ibp_cmd_chnl_valid     = bfed_ifu_merg_ibp_cmd_chnl_valid  ;
  assign bfed_ifu_merg_ibp_cmd_chnl_accept    = bfed_ifu_merg_bfed_ibp_cmd_chnl_accept ;
  assign bfed_ifu_merg_bfed_ibp_cmd_chnl           = bfed_ifu_merg_ibp_cmd_chnl        ;

  assign bfed_ifu_merg_bfed_ibp_wd_chnl_valid      = bfed_ifu_merg_ibp_wd_chnl_valid   ;
  assign bfed_ifu_merg_ibp_wd_chnl_accept     = bfed_ifu_merg_bfed_ibp_wd_chnl_accept  ;
  assign bfed_ifu_merg_bfed_ibp_wd_chnl            = bfed_ifu_merg_ibp_wd_chnl         ;

  assign bfed_ifu_merg_bfed_ibp_rd_chnl_accept     = bfed_ifu_merg_ibp_rd_chnl_accept  ;
  assign bfed_ifu_merg_ibp_rd_chnl_valid      = bfed_ifu_merg_bfed_ibp_rd_chnl_valid   ;
  assign bfed_ifu_merg_ibp_rd_chnl            = bfed_ifu_merg_bfed_ibp_rd_chnl         ;

  assign bfed_ifu_merg_bfed_ibp_wrsp_chnl_accept   = bfed_ifu_merg_ibp_wrsp_chnl_accept;
  assign bfed_ifu_merg_ibp_wrsp_chnl_valid    = bfed_ifu_merg_bfed_ibp_wrsp_chnl_valid ;
  assign bfed_ifu_merg_ibp_wrsp_chnl          = bfed_ifu_merg_bfed_ibp_wrsp_chnl       ;

  assign bfed_ifu_merg_bfed_ibp_cmd_chnl_user      = bfed_ifu_merg_ibp_cmd_chnl_user;


// Covert the bfed_ifu_merg_bfed_ IBP width



 wire [1-1:0] cvted_bfed_ifu_merg_bfed_ibp_cmd_chnl_valid;
 wire [1-1:0] cvted_bfed_ifu_merg_bfed_ibp_cmd_chnl_accept;
 wire [57 * 1 -1:0] cvted_bfed_ifu_merg_bfed_ibp_cmd_chnl;

 wire [1-1:0] cvted_bfed_ifu_merg_bfed_ibp_wd_chnl_valid;
 wire [1-1:0] cvted_bfed_ifu_merg_bfed_ibp_wd_chnl_accept;
 wire [73 * 1 -1:0] cvted_bfed_ifu_merg_bfed_ibp_wd_chnl;

 wire [1-1:0] cvted_bfed_ifu_merg_bfed_ibp_rd_chnl_accept;
 wire [1-1:0] cvted_bfed_ifu_merg_bfed_ibp_rd_chnl_valid;
 wire [67 * 1 -1:0] cvted_bfed_ifu_merg_bfed_ibp_rd_chnl;

 wire [1-1:0] cvted_bfed_ifu_merg_bfed_ibp_wrsp_chnl_valid;
 wire [1-1:0] cvted_bfed_ifu_merg_bfed_ibp_wrsp_chnl_accept;
 wire [3 * 1 -1:0] cvted_bfed_ifu_merg_bfed_ibp_wrsp_chnl;

wire [1-1:0] cvted_bfed_ifu_merg_bfed_ibp_cmd_chnl_user;

// Declare unused ports
// spyglass disable_block W240
// SMD: An input has been declared but is not read
// SJ: Unused instance ports are port-mapped but not connected
wire unused_bfed_ifu_merg_bfed_ibpx2ibpy_o_ibp_cmd_chnl_rgon;
// spyglass enable_block W240
npuarc_biu_ibpx2ibpy
 ...
 u_bfed_ifu_merg_bfed_ibp64toibp64 (
    .i_ibp_cmd_chnl_rgon   (1'b1),



    .i_ibp_cmd_chnl_valid  (bfed_ifu_merg_bfed_ibp_cmd_chnl_valid),
    .i_ibp_cmd_chnl_accept (bfed_ifu_merg_bfed_ibp_cmd_chnl_accept),
    .i_ibp_cmd_chnl        (bfed_ifu_merg_bfed_ibp_cmd_chnl),

    .i_ibp_rd_chnl_valid   (bfed_ifu_merg_bfed_ibp_rd_chnl_valid),
    .i_ibp_rd_chnl_accept  (bfed_ifu_merg_bfed_ibp_rd_chnl_accept),
    .i_ibp_rd_chnl         (bfed_ifu_merg_bfed_ibp_rd_chnl),

    .i_ibp_wd_chnl_valid   (bfed_ifu_merg_bfed_ibp_wd_chnl_valid),
    .i_ibp_wd_chnl_accept  (bfed_ifu_merg_bfed_ibp_wd_chnl_accept),
    .i_ibp_wd_chnl         (bfed_ifu_merg_bfed_ibp_wd_chnl),

    .i_ibp_wrsp_chnl_valid (bfed_ifu_merg_bfed_ibp_wrsp_chnl_valid),
    .i_ibp_wrsp_chnl_accept(bfed_ifu_merg_bfed_ibp_wrsp_chnl_accept),
    .i_ibp_wrsp_chnl       (bfed_ifu_merg_bfed_ibp_wrsp_chnl),

    .i_ibp_cmd_chnl_user   (bfed_ifu_merg_bfed_ibp_cmd_chnl_user),





    .o_ibp_cmd_chnl_valid  (cvted_bfed_ifu_merg_bfed_ibp_cmd_chnl_valid),
    .o_ibp_cmd_chnl_accept (cvted_bfed_ifu_merg_bfed_ibp_cmd_chnl_accept),
    .o_ibp_cmd_chnl        (cvted_bfed_ifu_merg_bfed_ibp_cmd_chnl),

    .o_ibp_rd_chnl_valid   (cvted_bfed_ifu_merg_bfed_ibp_rd_chnl_valid),
    .o_ibp_rd_chnl_accept  (cvted_bfed_ifu_merg_bfed_ibp_rd_chnl_accept),
    .o_ibp_rd_chnl         (cvted_bfed_ifu_merg_bfed_ibp_rd_chnl),

    .o_ibp_wd_chnl_valid   (cvted_bfed_ifu_merg_bfed_ibp_wd_chnl_valid),
    .o_ibp_wd_chnl_accept  (cvted_bfed_ifu_merg_bfed_ibp_wd_chnl_accept),
    .o_ibp_wd_chnl         (cvted_bfed_ifu_merg_bfed_ibp_wd_chnl),

    .o_ibp_wrsp_chnl_valid (cvted_bfed_ifu_merg_bfed_ibp_wrsp_chnl_valid),
    .o_ibp_wrsp_chnl_accept(cvted_bfed_ifu_merg_bfed_ibp_wrsp_chnl_accept),
    .o_ibp_wrsp_chnl       (cvted_bfed_ifu_merg_bfed_ibp_wrsp_chnl),
...
// SMD: Connected to floating net
// SJ: do not care this wrn
    .o_ibp_cmd_chnl_rgon   (unused_bfed_ifu_merg_bfed_ibpx2ibpy_o_ibp_cmd_chnl_rgon),
// spyglass enable_block UnloadedOutTerm-ML
    .o_ibp_cmd_chnl_user   (cvted_bfed_ifu_merg_bfed_ibp_cmd_chnl_user),
// leda B_1011 on
// leda WV951025 on
// spyglass enable_block W287b
...
wire bfed_ifu_merg_bfed_ibp_cmd_write_burst_en = 0;
wire [1+1-1:0] cvted_bfed_ifu_merg_bfed_ibp_cmd_chnl_wbursten_and_user =
         {bfed_ifu_merg_bfed_ibp_cmd_write_burst_en, cvted_bfed_ifu_merg_bfed_ibp_cmd_chnl_user};
...
wire [(1+1)*1 -1:0] cming_ibp_cmd_chnl_wbursten_and_user;
...
// leda NTL_CON13A on
 ...
 wire [57 * 1 -1:0] cming_ibp_cmd_chnl;
...
wire bfed_ifu_merg_bfed_ibp_lockable = 0;
...
assign {cming_ibp_lockable_dummy,
        ...
        = {
            1'b0
                  ,bfed_ifu_merg_bfed_ibp_lockable
   };
...
assign
  ...
  =
  {
    1'b1
              ,1'd0
                  ,cvted_bfed_ifu_merg_bfed_ibp_cmd_chnl_wbursten_and_user
                  ,cvted_bfed_ifu_merg_bfed_ibp_cmd_chnl
                  ,cvted_bfed_ifu_merg_bfed_ibp_cmd_chnl_valid
                  ,cvted_bfed_ifu_merg_bfed_ibp_wd_chnl
                  ,cvted_bfed_ifu_merg_bfed_ibp_wd_chnl_valid
                  ,cvted_bfed_ifu_merg_bfed_ibp_rd_chnl_accept
                  ,cvted_bfed_ifu_merg_bfed_ibp_wrsp_chnl_accept
  };
// leda NTL_CON16 on
...
assign
  {
    cming_dummy1
                  ,cvted_bfed_ifu_merg_bfed_ibp_rd_chnl
                  ,cvted_bfed_ifu_merg_bfed_ibp_rd_chnl_valid
                  ,cvted_bfed_ifu_merg_bfed_ibp_wrsp_chnl
                  ,cvted_bfed_ifu_merg_bfed_ibp_wrsp_chnl_valid
                  ,cvted_bfed_ifu_merg_bfed_ibp_cmd_chnl_accept
                  ,cvted_bfed_ifu_merg_bfed_ibp_wd_chnl_accept
  }
  =
    {
    1'b1,
...
wire [1-1:0] bfed_cmed_ibp_cmd_chnl_user;
  ...
  assign bfed_cmed_ibp_cmd_chnl_user      = cmed_ibp_cmd_chnl_user;
    ...
    wire [1-1:0] bfed_core0_nllm_l2ifu_ibp_cmd_user;
// Declare unused ports
// spyglass disable_block W240
// SMD: An input has been declared but is not read
// SJ: Unused instance ports are port-mapped but not connected
