...
`define    AM_ECC_2ND_TOTAL_WIDTH    72
`define    AM_ECC_2ND_TOTAL_RANGE    71:0
`define    AM_ECC_2ND_CHKBIT_WIDTH   8
`define    AM_ECC_2ND_CHKBIT_RANGE   71:64

// This function returns the check bits
function automatic [7:0] am_ecc_2nd_enc;
    input [63:0] data_in;
...
function automatic [7:0] am_ecc_2nd_dec_a;
    input [63:0] data_in;
    input [7 :0] ecc_in;
...
begin
    ...
    am_ecc_2nd_dec_a = {overall_parity, syndrome};
end
endfunction


// This function returns the {unknown_err, double_err, single_err};
function automatic [2:0] am_ecc_2nd_dec_b;
    input enable;
    input [6:0] syndrome;
...
// Checks if the syndrome is unused syndrome
    ...
    am_ecc_2nd_dec_b = {unknown_err, double_err, single_err};
end
endfunction


// This function returns the corrected data;
function automatic [63:0] am_ecc_2nd_dec_c;
    input overall_parity_and_enable;
    input [6:0] syndrome;
    input [63:0] data_in;
    reg [63:0] data_out;
begin
    ...
    am_ecc_2nd_dec_c = data_out;
end
endfunction


// This function returns the corrected ecc code;
function automatic [7 :0] am_ecc_2nd_dec_d;
    input overall_parity_and_enable;
    input [6:0] syndrome;
    input [7 :0] ecc_in;
    reg [7 :0] ecc_out;
