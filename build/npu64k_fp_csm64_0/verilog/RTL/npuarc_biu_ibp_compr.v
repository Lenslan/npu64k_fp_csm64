...
generate //{
  if(COMP_NUM == 1) begin: comp_num_eq_1_gen//{
    ...
    wire [COMP_NUM-1:0] other_i_ibp_locked;
    ...
    begin:ibp_compressor_req_gen
      ...
      if(i == 0) begin: i_is_0
        assign other_i_ibp_locked[i] = |(i_ibp_wait_unlock[COMP_NUM-1:1]);
      end
      else if (i == (COMP_NUM - 1)) begin: i_is_last
        assign other_i_ibp_locked[i] = |(i_ibp_wait_unlock[COMP_NUM-2:0]);
      end
      else begin: i_is_mid
        assign other_i_ibp_locked[i] = |({i_ibp_wait_unlock[COMP_NUM-1:i+1],i_ibp_wait_unlock[i-1:0]});
      end
...
wire [COMP_FIFO_DEPTH:0] unuse_wdata_chnl_i_occp;
wire [COMP_FIFO_DEPTH:0] unuse_wdata_chnl_o_occp;
...
// SJ:This signal is unused
      .i_occp    (unuse_wdata_chnl_i_occp),
      .o_occp    (unuse_wdata_chnl_o_occp),
      // leda B_1011 on
      // leda WV951025 on
...
wire [COMP_FIFO_DEPTH:0] unuse_rdata_chnl_i_occp;
wire [COMP_FIFO_DEPTH:0] unuse_rdata_chnl_o_occp;
...
// SMD: Connected to floating net
// SJ:This signal is unused
      .i_occp    (unuse_rdata_chnl_i_occp),
      .o_occp    (unuse_rdata_chnl_o_occp),
      // leda B_1011 on
      // leda WV951025 on
// spyglass enable_block UnloadedOutTerm-ML
// spyglass enable_block W287b
...
wire [COMP_FIFO_DEPTH:0] unuse_wresp_chnl_i_occp;
wire [COMP_FIFO_DEPTH:0] unuse_wresp_chnl_o_occp;
...
// SMD: Connected to floating net
// SJ:This signal is unused
      .i_occp    (unuse_wresp_chnl_i_occp),
      .o_occp    (unuse_wresp_chnl_o_occp),
      // leda B_1011 on
      // leda WV951025 on
// spyglass enable_block UnloadedOutTerm-ML
// spyglass enable_block W287b
