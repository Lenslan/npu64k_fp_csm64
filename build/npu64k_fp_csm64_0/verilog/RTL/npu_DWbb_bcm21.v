...
//
// Filename    : npu_DWbb_bcm21.v
// Revision    : $Id: $
// Author      : Doug Lee    2/20/05
// Description : npu_DWbb_bcm21.v Verilog module for npu_DWbb
//
...
generate
    ...
    if ((F_SYNC_TYPE & 7) == 1) begin : GEN_FST1
      npu_DWbb_bcm99_n U_SAMPLE_META_2_N[WIDTH-1:0] (
        .clk_d(clk_d),
        .rst_d_n(rst_d_n),
        .data_s(data_s_int),
        .data_d(data_d)
    ...
    if ((F_SYNC_TYPE & 7) == 2) begin : GEN_FST2
      ...
      npu_DWbb_bcm99 #(TECH_MAPPING_LAM) U_SAMPLE_META_2[WIDTH-1:0] (
        .clk_d(clk_d),
        .rst_d_n(rst_d_n),
    ...
    if ((F_SYNC_TYPE & 7) == 3) begin : GEN_FST3
      ...
      npu_DWbb_bcm99_3 #(0) U_SAMPLE_META_3[WIDTH-1:0] (
        .clk_d(clk_d),
        .rst_d_n(rst_d_n),
        .data_s(next_sample_meta),
        .data_d(sample_syncl)
    ...
    if ((F_SYNC_TYPE & 7) == 4) begin : GEN_FST4
      ...
      npu_DWbb_bcm99_4 #(0) U_SAMPLE_META_4[WIDTH-1:0] (
        .clk_d(clk_d),
        .rst_d_n(rst_d_n),
        .data_s(next_sample_meta),
        .data_d(sample_syncl)
...
`endif
  ...
  generate
    ...
    if (SVA_TYPE_BIT1BIT0 == 1) begin : GEN_SVATP_EQ_1
      ...
      npu_DWbb_sva01 #(WIDTH, (F_SYNC_TYPE & 7), VERIF_EN) P_SYNC_HS (.*);
    end
    ...
    `endif
      ...
      npu_DWbb_sva05 #(WIDTH, (F_SYNC_TYPE & 7)) P_SYNC_GC (.*);
    end

    if (SVA_TYPE_BIT2 == 0) begin : GEN_SVATP_BIT2_EQ_0
      npu_DWbb_sva08 #(WIDTH) P_SYNC_EQ_RST (.*);
    end
  endgenerate
  `else
    `ifdef DW_MODEL_MISSAMPLES
  npu_DWbb_bvm02 U_CLK_DET (
    .clk         (clk_d        ),
    .rst_n       (rst_d_n      ),
    .clk_stopped (clk_d_stopped),
    .clk_period  (clk_d_period )
