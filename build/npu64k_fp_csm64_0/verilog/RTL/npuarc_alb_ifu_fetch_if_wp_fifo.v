...
module npuarc_alb_ifu_fetch_if_wp_fifo 
  ( 
  input                    clk,
  input                    rst_a,
  input                    restart,
...
begin: fifo_mem_rd_nxt_PROC
  if (wr && (cnt_nxt == { {1{1'b0}}, 1'b1 })) begin //bypass input
    rdata_r_nxt = wdata[1: 1]; 
  end
  else begin
    rdata_r_nxt = rdata_erly[1: 1]; 
  end
end //block: fifo_mem_PROC
