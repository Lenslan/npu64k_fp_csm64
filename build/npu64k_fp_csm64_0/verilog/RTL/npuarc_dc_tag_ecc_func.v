...
`define    DC_TAG_ECC_TOTAL_WIDTH    34
`define    DC_TAG_ECC_TOTAL_RANGE    33:0
`define    DC_TAG_ECC_CHKBIT_WIDTH   7
`define    DC_TAG_ECC_CHKBIT_RANGE   33:27

// This function returns the check bits
function automatic [6:0] dc_tag_ecc_enc;
    input [26:0] data_in;
...
begin
    ...
    edc_tmp[0] = ^(word_in & 27'b110101010101010110101011011);
    edc_tmp[1] = ^(word_in & 27'b011001100110011011001101101);
    edc_tmp[2] = ^(word_in & 27'b011110000111100011110001110);
    edc_tmp[3] = ^(word_in & 27'b011111111000000011111110000);
    edc_tmp[4] = ^(word_in & 27'b011111111111111100000000000);
    edc_tmp[5] = ^(word_in & 27'b100000000000000000000000000);
...
function automatic [6:0] dc_tag_ecc_dec_a;
    input [26:0] data_in;
    input [6 :0] ecc_in;
...
begin
    ...
    calc_edc[0] = ^(word_in & 27'b110101010101010110101011011);
    calc_edc[1] = ^(word_in & 27'b011001100110011011001101101);
    calc_edc[2] = ^(word_in & 27'b011110000111100011110001110);
    calc_edc[3] = ^(word_in & 27'b011111111000000011111110000);
    calc_edc[4] = ^(word_in & 27'b011111111111111100000000000);
    calc_edc[5] = ^(word_in & 27'b100000000000000000000000000);
    ...
    dc_tag_ecc_dec_a = {overall_parity, syndrome};
end
endfunction


// This function returns the {unknown_err, double_err, single_err};
function automatic [2:0] dc_tag_ecc_dec_b;
    input enable;
    input [5:0] syndrome;
...
// Checks if the syndrome is unused syndrome
    is_unused_syndrome = (syndrome == 34) | (syndrome == 35) | (syndrome == 36) | (syndrome == 37) | (syndrome == 38) | (syndrome == 39) | 
    (syndrome == 40) | (syndrome == 41) | (syndrome == 42) | (syndrome == 43) | (syndrome == 44) | (syndrome == 45) | 
    (syndrome == 46) | (syndrome == 47) | (syndrome == 48) | (syndrome == 49) | (syndrome == 50) | (syndrome == 51) | 
    (syndrome == 52) | (syndrome == 53) | (syndrome == 54) | (syndrome == 55) | (syndrome == 56) | (syndrome == 57) | 
    (syndrome == 58) | (syndrome == 59) | (syndrome == 60) | (syndrome == 61) | (syndrome == 62) | (syndrome == 63);
    ...
    dc_tag_ecc_dec_b = {unknown_err, double_err, single_err};
end
endfunction


// This function returns the corrected data;
function automatic [26:0] dc_tag_ecc_dec_c;
    input single_err;
    input [5:0] syndrome;
    input [26:0] data_in;
    reg [26:0] data_out;
begin
    ...
    dc_tag_ecc_dec_c = data_out;
end
endfunction


// This function returns the corrected ecc code;
function automatic [6 :0] dc_tag_ecc_dec_d;
    input single_err;
    input [5:0] syndrome;
    input [6 :0] ecc_in;
    reg [6 :0] ecc_out;
