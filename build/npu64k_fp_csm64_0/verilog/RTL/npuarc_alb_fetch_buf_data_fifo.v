...
module npuarc_alb_fetch_buf_data_fifo 
  (
  input clk,
  input rst_a,
  input restart,
  ...
  input [141:0] wdata1,
  input [1:0] rd,
  output reg [141:0] rdata0,
  output reg [141:0] rdata1,
  output reg [141:0] rdata_next0,
  output reg [141:0] rdata_next1,
  output     [2:0] fifo_cnt,
...
reg [127:0]            mem0_p1;
reg [142-1:128] mem0_p2;
reg [127:0]            mem0_nxt_p1;
reg [142-1:128] mem0_nxt_p2;
reg [127:0]            mem1_p1;
reg [142-1:128] mem1_p2;
reg [127:0]            mem1_nxt_p1;
reg [142-1:128] mem1_nxt_p2;
always @ *
begin: buf_merge_PROC
mem0_nxt_p1 = mem0_nxt[127:0];
mem0_nxt_p2 = mem0_nxt[142-1:128];
mem0 = { mem0_p2,  mem0_p1};
mem1_nxt_p1 = mem1_nxt[127:0];
mem1_nxt_p2 = mem1_nxt[142-1:128];
mem1 = { mem1_p2,  mem1_p1};
end
