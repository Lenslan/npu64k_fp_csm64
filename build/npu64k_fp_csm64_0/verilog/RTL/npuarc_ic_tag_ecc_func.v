...
`define    IC_TAG_ECC_TOTAL_WIDTH    37
`define    IC_TAG_ECC_TOTAL_RANGE    36:0
`define    IC_TAG_ECC_CHKBIT_WIDTH   7
`define    IC_TAG_ECC_CHKBIT_RANGE   36:30
...
begin
    ...
    edc_tmp[0] = ^(word_in & 30'b101011010101010101010101011011);
    edc_tmp[1] = ^(word_in & 30'b001101100110011001101001101101);
    edc_tmp[2] = ^(word_in & 30'b110001111000011110001110001110);
    edc_tmp[3] = ^(word_in & 30'b000001111111100000001111110000);
    edc_tmp[4] = ^(word_in & 30'b000001111111111111110000000000);
    edc_tmp[5] = ^(word_in & 30'b111110000000000000000000000000);
...
begin
    ...
    calc_edc[0] = ^(word_in & 30'b101011010101010101010101011011);
    calc_edc[1] = ^(word_in & 30'b001101100110011001101001101101);
    calc_edc[2] = ^(word_in & 30'b110001111000011110001110001110);
    calc_edc[3] = ^(word_in & 30'b000001111111100000001111110000);
    calc_edc[4] = ^(word_in & 30'b000001111111111111110000000000);
    calc_edc[5] = ^(word_in & 30'b111110000000000000000000000000);
...
function automatic [2:0] ic_tag_ecc_dec_b;
    input enable;
    input [5:0] syndrome;
...
// Checks if the syndrome is unused syndrome
    is_unused_syndrome = (syndrome == 15) | (syndrome == 38) | (syndrome == 39) | (syndrome == 40) | (syndrome == 41) | (syndrome == 42) | 
    (syndrome == 43) | (syndrome == 44) | (syndrome == 45) | (syndrome == 46) | (syndrome == 47) | (syndrome == 48) | 
    (syndrome == 49) | (syndrome == 50) | (syndrome == 51) | (syndrome == 52) | (syndrome == 53) | (syndrome == 54) | 
    (syndrome == 55) | (syndrome == 56) | (syndrome == 57) | (syndrome == 58) | (syndrome == 59) | (syndrome == 60) | 
    (syndrome == 61) | (syndrome == 62) | (syndrome == 63);
    ...
    ic_tag_ecc_dec_b = {unknown_err, double_err, single_err};
end
endfunction


// This function returns the corrected data;
function automatic [29:0] ic_tag_ecc_dec_c;
    input single_err;
    input [5:0] syndrome;
    input [29:0] data_in;
    reg [29:0] data_out;
