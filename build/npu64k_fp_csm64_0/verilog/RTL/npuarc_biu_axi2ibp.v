...
module npuarc_biu_axi2ibp
  #(
   ...
   // The FIFO Depth indicated the FIFO entries
    ...
    parameter OUT_CMD_NUM = 4,
    parameter OUT_CMD_CNT_W = 2,
...
// NOTICE!!!!!
// for X_W < Y_W transfer, just support 32->64 32->128 64->128
//
generate //{
...
assign axi2ibp_cmd_addr_round =
  //3'b111: 1024bits transfer
  ({ADDR_W{axi2ibp_cmd_data_size == 3'd7}} & {axi2ibp_cmd_addr[ADDR_W-1:7],7'b0000000}) |
  //3'b110: 512bits transfer
  ({ADDR_W{axi2ibp_cmd_data_size == 3'd6}} & {axi2ibp_cmd_addr[ADDR_W-1:6],6'b000000}) |
  //3'b101: 256bits transfer
  ({ADDR_W{axi2ibp_cmd_data_size == 3'd5}} & {axi2ibp_cmd_addr[ADDR_W-1:5],5'b00000}) |
...
wire [ADDR_W-1:0] axi2ibp_cmd_addr_inc_nxt = (axi2ibp_cmd_addr_round +
       (
       //3'b111: 1024bits transfer
       {ADDR_W{axi2ibp_cmd_data_size == 3'd7}} & 128
       //3'b110: 512bits transfer
...
wire [ADDR_W-1:0] axi2ibp_cmd_wrap_vec =
       //3'b111: 1024bits transfer
       {ADDR_W{axi2ibp_cmd_data_size == 3'd7}} & {~{{ADDR_W-11{1'b0}}, axi2ibp_cmd_burst_size}, 7'b0}
       //3'b110: 512bits transfer
...
wire [ADDR_W-1:0] axi2ibp_sdb_addr_inc_nxt = (axi2ibp_sdb_addr_r +
       (
       //3'b111: 1024bits transfer
       {ADDR_W{axi2ibp_sdb_data_size_r == 3'd7}} & 128
       //3'b110: 512bits transfer
...
wire [ADDR_W-1:0] axi2ibp_sdb_wrap_vec =
       //3'b111: 1024bits transfer
       {ADDR_W{axi2ibp_sdb_data_size_r == 3'd7}} & {~{{ADDR_W-11{1'b0}}, axi2ibp_sdb_burst_size_r}, 7'b0}
       //3'b110: 512bits transfer
...
wire ibp_cmd_splt_uop = ibp_cmd_sel_sdb ? (axi2ibp_sdb_valid_r & (~axi2ibp_splt_cnt_last)) : axi2ibp_need_splt;
...
wire [SPLT_FIFO_DEPTH:0] unuse_wd_splt_uop_fifo_i_occp;
wire [SPLT_FIFO_DEPTH:0] unuse_wd_splt_uop_fifo_o_occp;
npuarc_biu_fifo # (
...
// SMD: Instance output port is not connected
// SJ: No care about the warning
  .i_occp    (unuse_wd_splt_uop_fifo_i_occp),
  .o_occp    (unuse_wd_splt_uop_fifo_o_occp),
// spyglass enable_block W287b
// leda B_1011 on
// leda WV951025 on
  .clk       (clk  ),
...
wire [SPLT_FIFO_DEPTH:0] unuse_rd_splt_uop_fifo_i_occp;
wire [SPLT_FIFO_DEPTH:0] unuse_rd_splt_uop_fifo_o_occp;
npuarc_biu_fifo # (
     .FIFO_DEPTH(SPLT_FIFO_DEPTH),
     .FIFO_WIDTH(1),
     .IN_OUT_MWHILE (0),
...
// SMD: Instance output port is not connected
// SJ: No care about the warning
  .i_occp    (unuse_rd_splt_uop_fifo_i_occp),
  .o_occp    (unuse_rd_splt_uop_fifo_o_occp),
// spyglass enable_block W287b
// leda B_1011 on
// leda WV951025 on
  .clk       (clk  ),
...
wire [SPLT_FIFO_DEPTH:0] unuse_wrsp_splt_uop_fifo_i_occp;
wire [SPLT_FIFO_DEPTH:0] unuse_wrsp_splt_uop_fifo_o_occp;
npuarc_biu_fifo # (
     .FIFO_DEPTH(SPLT_FIFO_DEPTH),
     .FIFO_WIDTH(1),
     .IN_OUT_MWHILE (0),
...
// SMD: Instance output port is not connected
// SJ: No care about the warning
  .i_occp    (unuse_wrsp_splt_uop_fifo_i_occp),
  .o_occp    (unuse_wrsp_splt_uop_fifo_o_occp),
// spyglass enable_block W287b
// leda B_1011 on
// leda WV951025 on
  .clk       (clk  ),
...
wire [SPLT_FIFO_DEPTH:0] unuse_rd_id_fifo_i_occp;
wire [SPLT_FIFO_DEPTH:0] unuse_rd_id_fifo_o_occp;
npuarc_biu_fifo # (
     .FIFO_DEPTH(SPLT_FIFO_DEPTH),
     .FIFO_WIDTH(BUS_ID_W),
     .IN_OUT_MWHILE (0),
...
// SMD: Instance output port is not connected
// SJ: No care about the warning
  .i_occp    (unuse_rd_id_fifo_i_occp),
  .o_occp    (unuse_rd_id_fifo_o_occp),
// spyglass enable_block W287b
// leda B_1011 on
// leda WV951025 on
  .clk       (clk  ),
...
wire [SPLT_FIFO_DEPTH:0] unuse_wrsp_id_fifo_i_occp;
wire [SPLT_FIFO_DEPTH:0] unuse_wrsp_id_fifo_o_occp;
npuarc_biu_fifo # (
     .FIFO_DEPTH(SPLT_FIFO_DEPTH),
     .FIFO_WIDTH(BUS_ID_W),
     .IN_OUT_MWHILE (0),
...
// SMD: Instance output port is not connected
// SJ: No care about the warning
  .i_occp    (unuse_wrsp_id_fifo_i_occp),
  .o_occp    (unuse_wrsp_id_fifo_o_occp),
// spyglass enable_block W287b
// leda B_1011 on
// leda WV951025 on
  .clk       (clk  ),
...
assign i_axi_rresp = (ibp_err_rd & ibp_rd_accept) ? 2'b10 : ibp_rd_excl_ok ? 2'b01 : 2'b00;//SLVERR or OKAY
// leda NTL_CON16 on
...
assign i_axi_bresp = ((ibp_err_wr | ibp_err_wr_r) & ibp_wr_resp_accept) ? 2'b10 //SLVERR,we need to make sure all the response accumulated
