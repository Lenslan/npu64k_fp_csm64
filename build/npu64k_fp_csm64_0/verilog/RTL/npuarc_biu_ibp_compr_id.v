...
module npuarc_biu_ibp_compr_id
  #(
// leda W175 off
...
// leda W175 on
  ...
  // spyglass disable_block W240
  // SMD: input port declared but not read
  // SJ:  Some signals bit field are indeed no driven
// leda NTL_CON13C off
// LMD: non driving internal net
// LJ: Some signals bit field are indeed no driven
// leda NTL_CON37 off
// LMD: Signal/Net must read from the input port in module
// LJ: Some signals bit field are indeed not read and used
  input [ID_WIDTH-1:0] o_ibp_rd_chnl_id,
  input [ID_WIDTH-1:0] o_ibp_wrsp_chnl_id,
// leda NTL_CON37 on
// leda NTL_CON13C on
  // spyglass enable_block W240
  //
...
// spyglass enable_block W287b
    ...
    assign back_rdata_chnl_uniq_id = o_ibp_rd_chnl_id[COMP_FIFO_WIDTH-1:0];
    assign back_wresp_chnl_uniq_id = o_ibp_wrsp_chnl_id[COMP_FIFO_WIDTH-1:0];
