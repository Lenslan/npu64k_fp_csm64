...
wire [SPLT_FIFO_DEPTH:0] unused_wd_splt_uop_fifo_i_occp;
wire [SPLT_FIFO_DEPTH:0] unused_wd_splt_uop_fifo_o_occp;
...
// SJ: do not care this wrn
  .i_occp    (unused_wd_splt_uop_fifo_i_occp),
  .o_occp    (unused_wd_splt_uop_fifo_o_occp),
...
// SMD: An input has been declared but is not read
// SJ: Unused instance ports are port-mapped but not connected
wire [SPLT_FIFO_DEPTH:0] unused_rd_splt_uop_fifo_i_occp;
wire [SPLT_FIFO_DEPTH:0] unused_rd_splt_uop_fifo_o_occp;
// spyglass enable_block W240
...
// SMD: Connected to floating net
// SJ: do not care this wrn
  .i_occp    (unused_rd_splt_uop_fifo_i_occp),
  .o_occp    (unused_rd_splt_uop_fifo_o_occp),
// spyglass enable_block UnloadedOutTerm-ML
  // leda B_1011 on
  // leda WV951025 on
// spyglass enable_block W287b
...
// SMD: An input has been declared but is not read
// SJ: Unused instance ports are port-mapped but not connected
wire [SPLT_FIFO_DEPTH:0] unused_wrsp_splt_uop_fifo_i_occp;
wire [SPLT_FIFO_DEPTH:0] unused_wrsp_splt_uop_fifo_o_occp;
// spyglass enable_block W240
...
// SMD: Connected to floating net
// SJ: do not care this wrn
  .i_occp    (unused_wrsp_splt_uop_fifo_i_occp),
  .o_occp    (unused_wrsp_splt_uop_fifo_o_occp),
// spyglass enable_block UnloadedOutTerm-ML
  // leda B_1011 on
  // leda WV951025 on
// spyglass enable_block W287b
