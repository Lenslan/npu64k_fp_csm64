...
`define    MMU_PD0_ECC_TOTAL_WIDTH    33
`define    MMU_PD0_ECC_TOTAL_RANGE    32:0
`define    MMU_PD0_ECC_CHKBIT_WIDTH   7
`define    MMU_PD0_ECC_CHKBIT_RANGE   32:26

// This function returns the check bits
function automatic [6:0] mmu_pd0_ecc_enc;
    input [25:0] data_in;
...
begin
    ...
    edc_tmp[0] = ^(word_in & 26'b11010101010101010101011011);
    edc_tmp[1] = ^(word_in & 26'b01100110011001101001101101);
    edc_tmp[2] = ^(word_in & 26'b01111000011110001110001110);
    edc_tmp[3] = ^(word_in & 26'b01111111100000001111110000);
    edc_tmp[4] = ^(word_in & 26'b01111111111111110000000000);
    edc_tmp[5] = ^(word_in & 26'b10000000000000000000000000);
...
function automatic [6:0] mmu_pd0_ecc_dec_a;
    input [25:0] data_in;
    input [6 :0] ecc_in;
...
begin
    ...
    calc_edc[0] = ^(word_in & 26'b11010101010101010101011011);
    calc_edc[1] = ^(word_in & 26'b01100110011001101001101101);
    calc_edc[2] = ^(word_in & 26'b01111000011110001110001110);
    calc_edc[3] = ^(word_in & 26'b01111111100000001111110000);
    calc_edc[4] = ^(word_in & 26'b01111111111111110000000000);
    calc_edc[5] = ^(word_in & 26'b10000000000000000000000000);
    ...
    mmu_pd0_ecc_dec_a = {overall_parity, syndrome};
end
endfunction


// This function returns the {unknown_err, double_err, single_err};
function automatic [2:0] mmu_pd0_ecc_dec_b;
    input enable;
    input [5:0] syndrome;
...
// Checks if the syndrome is unused syndrome
    is_unused_syndrome = (syndrome == 15) | (syndrome == 34) | (syndrome == 35) | (syndrome == 36) | (syndrome == 37) | (syndrome == 38) | 
    (syndrome == 39) | (syndrome == 40) | (syndrome == 41) | (syndrome == 42) | (syndrome == 43) | (syndrome == 44) | 
    ...
    mmu_pd0_ecc_dec_b = {unknown_err, double_err, single_err};
end
endfunction


// This function returns the corrected data;
function automatic [25:0] mmu_pd0_ecc_dec_c;
    input single_err;
    input [5:0] syndrome;
    input [25:0] data_in;
    reg [25:0] data_out;
begin
    ...
    mmu_pd0_ecc_dec_c = data_out;
end
endfunction


// This function returns the corrected ecc code;
function automatic [6 :0] mmu_pd0_ecc_dec_d;
    input single_err;
    input [5:0] syndrome;
    input [6 :0] ecc_in;
    reg [6 :0] ecc_out;
