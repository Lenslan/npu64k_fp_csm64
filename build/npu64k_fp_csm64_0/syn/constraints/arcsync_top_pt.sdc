# Note: This file is used in PrimeTime only for additional check. User should load arcsync_top.sdc and this file both in PT.

# function to set maximum skew between bits of a vector
proc as_max_skew_vector { sig numbits maxskew } {
  if { $numbits == 0 } {
