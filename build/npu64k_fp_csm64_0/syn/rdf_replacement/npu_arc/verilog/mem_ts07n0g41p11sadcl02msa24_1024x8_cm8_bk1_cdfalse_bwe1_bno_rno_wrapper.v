...
//  Date of Generation : Mon Apr 29 05:58:38 PDT 2024                  
//                                                                     
//---------------------------------------------------------------------
//   --------------------------------------------------------------     
...
//                                                                    
// Memory Name:mem_ts07n0g41p11sadcl02msa24_1024x8_cm8_bk1_cdfalse_bwe1_bno_rno 
...
module mem_ts07n0g41p11sadcl02msa24_1024x8_cm8_bk1_cdfalse_bwe1_bno_rno_wrapper (Q ,ADR ,D ,WEM ,WE ,ME ,CLK ,LS ,DS ,SD );
...
mem_ts07n0g41p11sadcl02msa24_1024x8_cm8_bk1_cdfalse_bwe1_bno_rno u_mem (  .Q(Q), .ROP(ROP), .ADR(ADR), .D(D), .WEM(WEM), .WE(WE), .ME(ME), .CLK(CLK), .TEST1(1'b0), .TEST_RNM(1'b0), .RME(1'b0), .RM(4'b0011), .LS(LS), .DS(DS), .SD(SD), .BC0(1'b0), .BC1(1'b1), .BC2(1'b0));
