...
source -echo ./setup/setup_arcsync_dcls.tcl
...
if { ! ($ELAB_ONLY==2 && $DESIGN_NAME=="npu_top") } {
...
if { ${MODE} eq "RTL_OPT" } {
    ...
    gui_show_map -map pinDensityMap -show true -window $layout_w
    change_selection [gui_explore_logic_hierarchy -expand]
    gui_write_window_image -file "${rptpfx}.pin_density.png" -window $layout_w

    gui_load_cell_density_mm
    gui_show_map -map cellDensityMap -show true -window $layout_w
    gui_set_map_option -map cellDensityMap -option max_threshold -value 1.5
    change_selection [gui_explore_logic_hierarchy -expand]
    gui_write_window_image -file "${rptpfx}.cell_density.png" -window $layout_w
