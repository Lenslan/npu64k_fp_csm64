...
/**                                                                     **/
/*************************************************************************/
#ifndef NPU_ACT_COMMON_TENSOR_API_IMPL_TENSOR_GTOA_BINARY_MOVF_MM_INLINE_HPP_
#define NPU_ACT_COMMON_TENSOR_API_IMPL_TENSOR_GTOA_BINARY_MOVF_MM_INLINE_HPP_
/*
 * tensor_gtoa_binary_movf_mm_inline.hpp
 *
...
gtoa_binary_movf_mm_params<B>::gtoa_binary_movf_mm_params(
...
template<template<typename> class B>
void gtoa_binary_movf_mm_params<B>::init_bin_prog(act_bin_op_t opi, broadcast_t brdc_f) {
  // initialize the binary_movf_mm microcode
  init_binary_movf_rr(HLAPI, opi);
}

#undef HLAPI

#endif  // NPU_ACT_COMMON_TENSOR_API_IMPL_TENSOR_GTOA_BINARY_MOVF_MM_INLINE_HPP_
