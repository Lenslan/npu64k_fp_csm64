...
/*
 * tensor_gtoa_binary_mb_inline_legacy.hpp
 *
 * File defining a tensor level binary API base on the generic tensor operation API
 *
 */

#ifndef TENSOR_GTOA_BINARY_MB_INLINE_LEGACY_HPP_        // [NOLINT]

#define TENSOR_GTOA_BINARY_MB_INLINE_LEGACY_HPP_        // [NOLINT]
...
#endif  // TENSOR_GTOA_BINARY_MB_LEAGCY_INLINE_HPP_      // [NOLINT]
