...
#ifndef TENSOR_GTOA_UNARY_INCLUDED
#define TENSOR_GTOA_UNARY_INCLUDED
...
namespace tensor::v200 {
  ...
  class gtoa_unary_params : public gtoa_params<B> {
  public:
    //
    // Constructor
    //
    // type parameterizable, unary opcode
    gtoa_unary_params(
    ...
    // type parameterizable, binary opcode, second input 0
    gtoa_unary_params(
                      aoffset_t                  noi,           // number output channels (not vectors)
                      const shape<3>&            oshpi,         // output shape, indexed by spatial_axis_t
    ...
    inline gtoa_unary_params() = default;
    inline gtoa_unary_params(const gtoa_unary_params&)  = default;
...
#include "./legacy/tensor_gtoa_unary_legacy.hpp"

  private:
    // include implementation specific private members
#include "tensor_gtoa_unary_param_priv.hpp"
  };

  // include implementation specific inline functionsinclude "tensor_gtoa_unary_inline.hpp"
#include "tensor_gtoa_unary_inline.hpp"
}
#endif
