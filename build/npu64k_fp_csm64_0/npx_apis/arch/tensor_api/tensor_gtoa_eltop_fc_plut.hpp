...
#ifndef TENSOR_GTOA_ELTOP_FC_PLUT_INCLUDED
#define TENSOR_GTOA_ELTOP_FC_PLUT_INCLUDED


// include interface datatypes
#include "tensor_gtoa_eltop_fc_act.hpp"
...
namespace tensor::v200 {
  ...
  class gtoa_eltop_fc_plut_params : public gtoa_eltop_fc_act_params<B> {
  public:
    //
    // Constructor
    //
    gtoa_eltop_fc_plut_params(
    ...
    inline gtoa_eltop_fc_plut_params() = default;
    inline gtoa_eltop_fc_plut_params(const gtoa_eltop_fc_plut_params&)  = default;
...
#include "./legacy/tensor_gtoa_eltop_fc_plut_legacy.hpp"

#include "tensor_gtoa_eltop_fc_plut_param_priv.hpp"
  };

  // include implementation specific inline functions
#include "tensor_gtoa_eltop_fc_plut_inline.hpp"
}
#endif
