...
/*
 * tensor_gtoa_eltop_rescale.hpp
 *
 * File defining a tensor level fused element-wise add and rescale API base on the generic tensor operation API
 *
 */
...
#ifndef TENSOR_API_TENSOR_GTOA_ELTOP_RESCALE_HPP_
#define TENSOR_API_TENSOR_GTOA_ELTOP_RESCALE_HPP_
...
namespace tensor::v200 {
  ...
  class gtoa_eltop_rescale_params : public gtoa_eltop_act_params<B> {
  public:
    //
    // Constructor
    //
    gtoa_eltop_rescale_params(
                      ...
                      act_dtype_t                in1tp,         // type of primary input
    ...
    inline gtoa_eltop_rescale_params() = default;
    inline gtoa_eltop_rescale_params(const gtoa_eltop_rescale_params&)  = default;
...
#include "./legacy/tensor_gtoa_eltop_rescale_legacy.hpp"

#include "tensor_gtoa_eltop_rescale_param_priv.hpp"  // NOLINT [build/include_subdir]
  };

  // include implementation specific inline functions
#include "tensor_gtoa_eltop_rescale_inline.hpp"  // NOLINT [build/include_subdir]
}
#endif  // TENSOR_API_TENSOR_GTOA_ELTOP_RESCALE_HPP_
