...
#ifndef TENSOR_API_TENSOR_GTOA_RELU_HPP_
#define TENSOR_API_TENSOR_GTOA_RELU_HPP_


// include interface datatypes
#include "tensor_gtoa_act.hpp"    // NOLINT [build/include_subdir]
...
class gtoa_relu_params : public gtoa_act_params<B> {
 public:
  //
  // Constructor
  //
  ...
  inline gtoa_relu_params() = default;
  inline gtoa_relu_params(const gtoa_relu_params&)  = default;
...
#include "./legacy/tensor_gtoa_relu_legacy.hpp"

#include "tensor_gtoa_relu_param_priv.hpp"   // NOLINT [build/include_subdir]
};

  // include implementation specific inline functions
#include "tensor_gtoa_relu_inline.hpp"       // NOLINT [build/include_subdir]
}  // namespace tensor::v200
#endif  // TENSOR_API_TENSOR_GTOA_RELU_HPP_
