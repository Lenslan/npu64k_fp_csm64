...
#ifndef TENSOR_GTOA_PLUT_INCLUDED
#define TENSOR_GTOA_PLUT_INCLUDED
...
class gtoa_plut_params : public gtoa_act_params<B> {
  public:
  //
  // Constructor
  //
  ...
  inline gtoa_plut_params() = default;
  inline gtoa_plut_params(const gtoa_plut_params<B>&)  = default;
...
#include "./legacy/tensor_gtoa_plut_legacy.hpp"

  private:
  // include implementation specific private members
#include "tensor_gtoa_plut_param_priv.hpp"
};

// include implementation specific inline functionsinclude "tensor_gtoa_plut_inline.hpp"
#include "tensor_gtoa_plut_inline.hpp"
}
#endif
