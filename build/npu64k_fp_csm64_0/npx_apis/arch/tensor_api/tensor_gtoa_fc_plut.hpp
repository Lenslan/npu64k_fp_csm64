...
#ifndef TENSOR_API_TENSOR_GTOA_FC_PLUT_HPP_
#define TENSOR_API_TENSOR_GTOA_FC_PLUT_HPP_
...
class gtoa_fc_plut_params : public gtoa_fc_act_params<B> {
 public:
  //
  // Constructor
  //
  ...
  gtoa_fc_plut_params(
      ...
      act_dtype_t  outtp,            // type of input
      bool         inastri = false,  // if true then stream directly from convolution
      bool         poscli = false);  // if true then do post scaling
  inline gtoa_fc_plut_params() = default;
  inline gtoa_fc_plut_params(const gtoa_fc_plut_params&)  = default;
...
#include "./legacy/tensor_gtoa_fc_plut_legacy.hpp"

#include "./tensor_gtoa_fc_plut_param_priv.hpp"
};

// include implementation specific inline functions
#include "./tensor_gtoa_fc_plut_inline.hpp"
}   // namespace tensor::v200
#endif    // TENSOR_API_TENSOR_GTOA_FC_PLUT_HPP_
