...
#ifndef TENSOR_GTOA_RELU1_INCLUDED
#define TENSOR_GTOA_RELU1_INCLUDED
...
namespace tensor::v200 {
  ...
  class gtoa_relu1_params : public gtoa_act_params<B> {
  public:
    //
    // Constructor
    //
    ...
    inline gtoa_relu1_params() = default;
    inline gtoa_relu1_params(const gtoa_relu1_params&)  = default;
    ...
    void param_enc(const tensor_t<prescale_t,1,xbuffer_t>&   prescale,    // per channel 2b+6b prescale for scaling down wide accumulators (pse
                   ...
                   const tensor_t<fp_e8m23_t,1,xbuffer_t>&   clipmax,     // per channel output clipmax[Cout]
                   const tensor_t<prescale_t,1,xbuffer_t>&   post,        // per channel postscale + asymmetric offset[Cout]
...
#include "./legacy/tensor_gtoa_relu1_legacy.hpp"

#include "tensor_gtoa_relu1_param_priv.hpp"
  };

  // include implementation specific inline function
#include "tensor_gtoa_relu1_inline.hpp"
}
#endif
