...
#ifndef TENSOR_API_TENSOR_GTOA_REDUCE_HPP_
#define TENSOR_API_TENSOR_GTOA_REDUCE_HPP_
...
///////////////////////////////////////////////////////////////////////////////////////////////
enum act_red_op_t {
  gtoa_red_and,       // reduce bitwise and
  gtoa_red_or,        // reduce bitwise or
  gtoa_red_add,       // reduce add
  gtoa_red_max,       // reduce maximum
  gtoa_red_min};      // reduce minimum

template <template <typename> class B = buffer_t>
class gtoa_reduce_params : public gtoa_params<B> {
 public:
    //
    // Constructor
    //
    ...
    inline gtoa_reduce_params() = default;
    inline gtoa_reduce_params(const gtoa_reduce_params &) = default;
...
#include "./legacy/tensor_gtoa_reduce_legacy.hpp"

 private:
        // include implementation specific private members
        #include "./tensor_gtoa_reduce_param_priv.hpp"
};
// include implementation specific inline
#include "./tensor_gtoa_reduce_inline.hpp"
}   // namespace tensor::v200
#endif    // TENSOR_API_TENSOR_GTOA_REDUCE_HPP_
