...
/*
 * tensor_gtoa_eltop_rescale_legacy.hpp
 *
 * File defining a tensor level fused element-wise add and rescale API base on the generic tensor operation API
 *
 */
#ifndef TENSOR_API_TENSOR_GTOA_ELTOP_RESCALE_LEGACY_HPP_
#define TENSOR_API_TENSOR_GTOA_ELTOP_RESCALE_LEGACY_HPP_
//
// Constructor
//
...
#endif  // TENSOR_API_TENSOR_GTOA_ELTOP_RESCALE_LEGACY_HPP_
