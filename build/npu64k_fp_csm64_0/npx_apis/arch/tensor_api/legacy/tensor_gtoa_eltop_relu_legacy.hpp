...
/*
 * tensor_gtoa_eltop_relu_legacy.hpp
 *
 * File defining a tensor level fused element-wise add and relu API base on the generic tensor operation API
 *
 */

#ifndef TENSOR_API_GTOA_ELTOP_RELU_LEGACY_HPP_
#define TENSOR_API_GTOA_ELTOP_RELU_LEGACY_HPP_
//
// Constructor
//
...
#endif // TENSOR_API_GTOA_ELTOP_RELU_LEGACY_HPP_
