...
/*
 * tensor_gtoa_eltop_relu6_legacy.hpp
 *
 * File defining a tensor level fused element-wise add and relu6 API base on the generic tensor operation API
 *
 */

#ifndef TENSOR_API_TENSOR_GTOA_ELTOP_RELU6_LEGACY_HPP_
#define TENSOR_API_TENSOR_GTOA_ELTOP_RELU6_LEGACY_HPP_
//
// Constructor
//
...
#endif   // TENSOR_API_TENSOR_GTOA_ELTOP_RELU6_LEGACY_HPP_
