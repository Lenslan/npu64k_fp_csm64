...
/*
 * tensor_gtoa_relu1_legacy.hpp
 *
 * File defining a tensor level relu1 API base on the generic tensor operation API
 *
 */

#ifndef TENSOR_GTOA_RELU1_LEGACY_INCLUDED
#define TENSOR_GTOA_RELU1_LEGACY_INCLUDED
...
void param_enc(const tensor_t<int32_t,1,xbuffer_t>&      bias,        // per channel bias [Cout]
               ...
               const tensor_t<int32_t,1,xbuffer_t>&      clipmax,     // per channel output clipmax[Cout]
