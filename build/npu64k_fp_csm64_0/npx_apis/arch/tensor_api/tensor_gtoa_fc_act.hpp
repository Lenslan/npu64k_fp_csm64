...
#ifndef TENSOR_GTOA_FC_ACT_INCLUDED
#define TENSOR_GTOA_FC_ACT_INCLUDED
...
namespace tensor::v200 {
  ...
  class gtoa_fc_act_params : public gtoa_params<B> {
  public:
    //
    // Constructors
    //
    ...
    inline gtoa_fc_act_params() = default;
    inline gtoa_fc_act_params(const gtoa_fc_act_params&)  = default;
...
#include "./legacy/tensor_gtoa_fc_act_legacy.hpp"

  protected:
    // include implementation specific private members
#include "tensor_gtoa_fc_act_param_priv.hpp"
  };

  // include implementation specific inline functions
#include "tensor_gtoa_fc_act_inline.hpp"
}
#endif
