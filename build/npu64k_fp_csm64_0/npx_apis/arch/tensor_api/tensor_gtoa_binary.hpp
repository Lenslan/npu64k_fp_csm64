...
#ifndef TENSOR_GTOA_BINARY_INCLUDED
#define TENSOR_GTOA_BINARY_INCLUDED
...
namespace tensor::v200 {
  ...
  class gtoa_binary_params : public gtoa_params<B> {
  public:
    //
    // Constructor
    //
    ...
    inline gtoa_binary_params() = default;
    inline gtoa_binary_params(const gtoa_binary_params&)  = default;
