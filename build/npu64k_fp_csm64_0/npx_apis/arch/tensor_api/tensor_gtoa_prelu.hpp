...
#ifndef TENSOR_GTOA_PRELU_INCLUDED
#define TENSOR_GTOA_PRELU_INCLUDED
...
namespace tensor::v200 {
  ...
  class gtoa_prelu_params : public gtoa_act_params<B> {
  public:
    //
    // Constructor
    //
    ...
    inline gtoa_prelu_params() = default;
    inline gtoa_prelu_params(const gtoa_prelu_params&)  = default;

    //
    // Parameter encoding functions
    //
    // fp16 scales
    void param_enc(const tensor_t<prescale_t,1,xbuffer_t>&   prescale,    // per channel prescale + bias [Cout]
...
#include "./legacy/tensor_gtoa_prelu_legacy.hpp"

#include "tensor_gtoa_prelu_param_priv.hpp"
  };

  // include implementation specific inline functions
#include "tensor_gtoa_prelu_inline.hpp"
}
#endif
