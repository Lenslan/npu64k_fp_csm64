...
#ifndef TENSOR_GTOA_NULLARY_INCLUDED
#define TENSOR_GTOA_NULLARY_INCLUDED
...
namespace tensor::v200 {
  ...
  enum act_nula_op_t {op_null_getid, op_null_strv, op_null_strc};

  template<template<typename> class B=buffer_t>
  class gtoa_nullary_params : public gtoa_params<B>{
  public:
    //
    // Constructor
    //
    ...
    inline gtoa_nullary_params() = default;
    inline gtoa_nullary_params(const gtoa_nullary_params&) = default;
