...
#ifndef TENSOR_GTOA_BINARY_MB_INCLUDED
#define TENSOR_GTOA_BINARY_MB_INCLUDED
...
namespace tensor::v200 {
  ...
  class gtoa_binary_mb_params : public gtoa_binary_params<B> {
  public:
    //
    // Constructor
    //
    ...
    inline gtoa_binary_mb_params() = default;
    inline gtoa_binary_mb_params(const gtoa_binary_mb_params&)  = default;

    //
    // Parameter encoding functions
    //
    void param_enc(const tensor_t<int32_t,1,xbuffer_t>&      bop,        // per channel B operand [Cout]
                   // outputs, buffers preallocated by caller
                   gtoa_params_impl_pchan<xbuffer_t>&         obuf                  // output encoded parameters
                   );
  // include legacy interface
#include "./legacy/tensor_gtoa_binary_mb_legacy.hpp"

    // include implementation specific private members
#include "tensor_gtoa_binary_mb_param_priv.hpp"
  };

  // include implementation specific inline functionsinclude "tensor_gtoa_binary_inline.hpp"
#include "tensor_gtoa_binary_mb_inline.hpp"
}
#endif
