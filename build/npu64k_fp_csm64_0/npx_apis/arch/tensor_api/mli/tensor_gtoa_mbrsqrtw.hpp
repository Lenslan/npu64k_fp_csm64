...
/*
 * tensor_gtoa_mbrsqrtw.hpp
 *
 * File defining w dim inp0/sqrt(inp1+epsilon) API base on the generic tensor operation API
 *
 */
...
#ifndef TENSOR_API_TENSOR_GTOA_MBRSQRTW_HPP_
#define TENSOR_API_TENSOR_GTOA_MBRSQRTW_HPP_
...
//
// TO compute (x-mean)/sqrt(var^2 + epsilon) at spatial wise
//d
...
class gtoa_mbrsqrtw_params : public gtoa_params<B> {
public:
  //
  // Constructor
  //
  // floating point extensions
  gtoa_mbrsqrtw_params(
  ...
  inline gtoa_mbrsqrtw_params() = default;
  inline gtoa_mbrsqrtw_params(const gtoa_mbrsqrtw_params&)  = default;

  void set_mbrsqrtw_params();
 ...
 private:
        ...
        #include "./tensor_gtoa_mbrsqrtw_param_priv.hpp"
};
// include implementation specific inline
#include "./tensor_gtoa_mbrsqrtw_inline.hpp"
}   // namespace tensor
#endif    // TENSOR_API_TENSOR_GTOA_MBRSQRTW_HPP_
