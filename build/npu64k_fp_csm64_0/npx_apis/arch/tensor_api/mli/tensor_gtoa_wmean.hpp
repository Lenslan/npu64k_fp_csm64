...
#ifndef TENSOR_API_TENSOR_GTOA_WMEAN_HPP_
#define TENSOR_API_TENSOR_GTOA_WMEAN_HPP_
...
class gtoa_wmean_params : public gtoa_params<B> {
 public:
    inline gtoa_wmean_params() = default;
    inline gtoa_wmean_params(const gtoa_wmean_params &) = default;
    ...
    void modif_out_fm(
      ...
      act_dtype_t                      outtp,    // output datatype
 ...
 private:
        ...
        #include "./tensor_gtoa_wmean_param_priv.hpp"
};
// include implementation specific inline
#include "./tensor_gtoa_wmean_inline.hpp"
}   // namespace tensor::v200
#endif    // TENSOR_API_TENSOR_GTOA_WMEAN_HPP_
