...
/*
 * tensor_gtoa_gridpad.hpp
 *
 * File defining a tensor level pad-preparing float grid operation API
 *
 */
...
#ifndef TENSOR_API_TENSOR_GTOA_GRIDPAD_HPP_
#define TENSOR_API_TENSOR_GTOA_GRIDPAD_HPP_
...
// Gridpad
//
// This class is preparing a float grid for gridsample depending on padding type.
//
///////////////////////////////////////////////////////////////////////////////////////////////
template<template<typename> class B = buffer_t>
class gtoa_gridpad_params : public gtoa_params<B> {
 public:
  //
  // Constructors
  //
  ...
  gtoa_gridpad_params(
     ...
     const shape<2>&  dictshpi,      // dictionary shape, indexed by spatial_axis_t
     const shape<3>&  idxshpi,       // index shape, indexed by spatial_axis_t
     act_dtype_t      idxtp);        // type of index input (BF16 or FP16 only)
  // Default constructor
  inline gtoa_gridpad_params() = default;
  inline gtoa_gridpad_params(const gtoa_gridpad_params&)  = default;
...
#include "./tensor_gtoa_gridpad_param_priv.hpp"
};

// include implementation specific inline functions
#include "./tensor_gtoa_gridpad_inline.hpp"
}  // namespace tensor::v200

#endif  // TENSOR_API_TENSOR_GTOA_GRIDPAD_HPP_
