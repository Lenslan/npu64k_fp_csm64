...
/*
 * tensor_gtoa_cmse.hpp
 *
 * File defining a channel wise mean squared error API base on the generic tensor operation API
 *
 */
...
#ifndef TENSOR_API_TENSOR_GTOA_CMSE_HPP_
#define TENSOR_API_TENSOR_GTOA_CMSE_HPP_
...
///////////////////////////////////////////////////////////////////////////////////////////////
//
// Channelwise Mean Squared Error Class
//
// TO compute reduce_mean((x-mean)^2) at channel wise
//
...
class gtoa_cmse_params : public gtoa_creduce_base_params<B> {
 public:
    gtoa_cmse_params(
    ...
    inline gtoa_cmse_params() = default;
    inline gtoa_cmse_params(const gtoa_cmse_params &) = default;

 private:
        // include implementation specific private members
        #include "./tensor_gtoa_cmse_param_priv.hpp"
};
// include implementation specific inline
#include "./tensor_gtoa_cmse_inline.hpp"
}   // namespace tensor
#endif    // TENSOR_API_TENSOR_GTOA_CMSE_HPP_
