...
/*
 * tensor_gtoa_eltop_flut.hpp
 *
 * File defining a tensor level fused element-wise add and flut API base on the generic tensor operation API
 *
 */
...
#ifndef TENSOR_API_GTOA_ELTOP_FLUT_HPP_
#define TENSOR_API_GTOA_ELTOP_FLUT_HPP_
...
namespace tensor::v200 {
  ...
  class gtoa_eltop_flut_params : public gtoa_eltop_act_params<B> {
  public:
    //
    // Constructor
    //
    // Input AM32/48, output FM8/16
    gtoa_eltop_flut_params(
    ...
    inline gtoa_eltop_flut_params() = default;
    inline gtoa_eltop_flut_params(const gtoa_eltop_flut_params&)  = default;
...
//#include "./legacy/tensor_gtoa_eltop_flut_legacy.hpp"

#include "tensor_gtoa_eltop_flut_param_priv.hpp"
  };

  // include implementation specific inline functions
#include "tensor_gtoa_eltop_flut_inline.hpp"
}
#endif // TENSOR_API_GTOA_ELTOP_FLUT_HPP_
