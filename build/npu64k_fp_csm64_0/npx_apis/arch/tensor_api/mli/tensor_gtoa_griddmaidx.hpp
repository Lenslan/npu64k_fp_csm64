...
/*
 * tensor_gtoa_griddmaidx.hpp
 *
 * File defining a tensor level gather iDMA index preparation API
 *
 */
...
#ifndef TENSOR_API_TENSOR_GTOA_GRIDDMAIDX_HPP_
#define TENSOR_API_TENSOR_GTOA_GRIDDMAIDX_HPP_
...
class gtoa_griddmaidx_params : public gtoa_params<B> {
 public:
  //
  // Constructors
  //
  // VM(8b/16b) to VM(8b/16b)
  gtoa_griddmaidx_params(
     const shape<3>&  idxshpi,       // index shape, indexed by spatial_axis_t
     act_dtype_t      idxtp);        // type of index input (BF16 or FP16 only)
  // Default constructor
  inline gtoa_griddmaidx_params() = default;
  inline gtoa_griddmaidx_params(const gtoa_griddmaidx_params&)  = default;
...
#include "./tensor_gtoa_griddmaidx_param_priv.hpp"
};

// include implementation specific inline functions
#include "./tensor_gtoa_griddmaidx_inline.hpp"
}  // namespace tensor::v200

#endif  // TENSOR_API_TENSOR_GTOA_GRIDDMAIDX_HPP_
