...
/*
 * tensor_gtoa_gridsample.hpp
 *
 * File defining a tensor level float grid sample tensor operation API
 *
 */
...
#ifndef TENSOR_API_TENSOR_GTOA_GRIDSAMPLE_HPP_
#define TENSOR_API_TENSOR_GTOA_GRIDSAMPLE_HPP_
...
// Gridsample
//
// This class is doing a gridsample on float grid.
//
///////////////////////////////////////////////////////////////////////////////////////////////
template<template<typename> class B = buffer_t>
class gtoa_gridsample_params : public gtoa_params<B> {
 public:
  //
  // Constructors
  //
  // VM(8b/16b) to VM(8b/16b)
  gtoa_gridsample_params(
  ...
  // Default constructor
  inline gtoa_gridsample_params() = default;
  inline gtoa_gridsample_params(const gtoa_gridsample_params&)  = default;
...
#include "./tensor_gtoa_gridsample_param_priv.hpp"
};

// include implementation specific inline functions
#include "./tensor_gtoa_gridsample_inline.hpp"
}  // namespace tensor::v200

#endif  // TENSOR_API_TENSOR_GTOA_GRIDSAMPLE_HPP_
