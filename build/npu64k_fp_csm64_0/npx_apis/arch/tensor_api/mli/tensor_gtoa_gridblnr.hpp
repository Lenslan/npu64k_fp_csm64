...
#ifndef TENSOR_API_TENSOR_GTOA_GRIDBLNR_HPP_
#define TENSOR_API_TENSOR_GTOA_GRIDBLNR_HPP_
...
// Gridblnr
//
// This class is doing a pre-gathered data bilinear interpolation on float grid.
//
///////////////////////////////////////////////////////////////////////////////////////////////
template<template<typename> class B = buffer_t>
class gtoa_gridblnr_params : public gtoa_params<B> {
 public:
  //
  // Constructors
  //
  // VM(8b/16b) to VM(8b/16b)
  gtoa_gridblnr_params(
  ...
  // Default constructor
  inline gtoa_gridblnr_params() = default;
  inline gtoa_gridblnr_params(const gtoa_gridblnr_params&)  = default;
...
#include "./tensor_gtoa_gridblnr_param_priv.hpp"
};

// include implementation specific inline functions
#include "./tensor_gtoa_gridblnr_inline.hpp"
}  // namespace tensor::v200

#endif  // TENSOR_API_TENSOR_GTOA_GRIDBLNR_HPP_
