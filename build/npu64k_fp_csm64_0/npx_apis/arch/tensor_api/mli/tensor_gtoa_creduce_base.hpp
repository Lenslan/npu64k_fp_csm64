...
#ifndef TENSOR_API_TENSOR_GTOA_CREDUCE_BASE_HPP_
#define TENSOR_API_TENSOR_GTOA_CREDUCE_BASE_HPP_
...
class gtoa_creduce_base_params : public gtoa_params<B> {
public:
  gtoa_creduce_base_params(
      aoffset_t noi,         // number output channels (not vectors)
      const shape<3> &ishpi, // input shape
      act_dtype_t intp,      // type of primary input
      act_dtype_t outtp);    // type of output

  inline gtoa_creduce_base_params() = default;
  inline gtoa_creduce_base_params(const gtoa_creduce_base_params &) = default;
  ...
  void set_creduce_params();

protected:
#include "./tensor_gtoa_creduce_base_param_priv.hpp"
};
// include implementation specific inline
#include "./tensor_gtoa_creduce_base_inline.hpp"
} // namespace tensor
#endif // TENSOR_API_TENSOR_GTOA_CREDUCE_BASE_HPP_
