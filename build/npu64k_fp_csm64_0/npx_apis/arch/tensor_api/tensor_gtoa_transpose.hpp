...
/*
 * tensor_gtoa_transpose.hpp
 *
 * File defining a tensor level transpose operation on the generic tensor operation API
 * The transpose operation transposes groups of channels from tns [D][H][W][C] to [D][H][C][W] layout
 */
...
#ifndef TENSOR_GTOA_TRANSPOSE_INCLUDED
#define TENSOR_GTOA_TRANSPOSE_INCLUDED
...
namespace tensor::v200 {
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////
  //
  // Transpose parameter class
  //
  ///////////////////////////////////////////////////////////////////////////////////////////////
  template<template<typename> class B=buffer_t>
  class gtoa_transpose_params : public gtoa_params<B> {
  public:
    //
    // Constructor
    //
    gtoa_transpose_params(
                         aoffset_t                noi,          // number output channels (not vectors)
                         const shape<3>&          ishpi,        // input shape, indexed by spatial_axis_t
                         bool                     fmdbli        // 8b/16b input feature-map
                         );
    inline gtoa_transpose_params() = default;
    inline gtoa_transpose_params(const gtoa_transpose_params<B>&) = default;
...
#include "tensor_gtoa_transpose_param_priv.hpp"
  };
  // include implementation specific inline functionsi
#include "tensor_gtoa_transpose_inline.hpp"
}
#endif
