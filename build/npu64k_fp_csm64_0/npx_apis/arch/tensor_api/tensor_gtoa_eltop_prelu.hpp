...
#ifndef TENSOR_GTOA_ELTOP_PRELU_INCLUDED
#define TENSOR_GTOA_ELTOP_PRELU_INCLUDED
...
namespace tensor::v200 {
  ...
  class gtoa_eltop_prelu_params : public gtoa_eltop_act_params<B> {
  public:
    //
    // Constructor
    //
    ...
    inline gtoa_eltop_prelu_params() = default;
    inline gtoa_eltop_prelu_params(const gtoa_eltop_prelu_params&)  = default;
...
#include "./legacy/tensor_gtoa_eltop_prelu_legacy.hpp"

#include "tensor_gtoa_eltop_prelu_param_priv.hpp"
  };

  // include implementation specific inline functions
#include "tensor_gtoa_eltop_prelu_inline.hpp"
}
#endif
