...
#ifndef TENSOR_GTOA_BINARY_MM_INCLUDED
#define TENSOR_GTOA_BINARY_MM_INCLUDED
...
namespace tensor::v200 {
  ...
  class gtoa_binary_mm_params : public gtoa_binary_params<B> {
  public:
    //
    // Constructor
    //
    // floating point extensions
    gtoa_binary_mm_params(
    ...
    inline gtoa_binary_mm_params() = default;
    inline gtoa_binary_mm_params(const gtoa_binary_mm_params&)  = default;
  // include legacy interface
#include "./legacy/tensor_gtoa_binary_mm_legacy.hpp"
    
    // include implementation specific private members
#include "tensor_gtoa_binary_mm_param_priv.hpp"
  };

  // include implementation specific inline functionsinclude "tensor_gtoa_binary_inline.hpp"
#include "tensor_gtoa_binary_mm_inline.hpp"
}
#endif
