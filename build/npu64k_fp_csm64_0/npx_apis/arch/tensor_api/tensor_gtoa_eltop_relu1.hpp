...
/*
 * tensor_gtoa_eltop_relu1.hpp
 *
 * File defining a tensor level fused element-wise add and relu1 API base on the generic tensor operation API
 *
 */
...
#ifndef TENSOR_API_GTOA_ELTOP_RELU1_HPP_
#define TENSOR_API_GTOA_ELTOP_RELU1_HPP_


// include interface datatypes
#include "tensor_gtoa_eltop_act.hpp"
...
namespace tensor::v200 {
  ...
  class gtoa_eltop_relu1_params : public gtoa_eltop_act_params<B> {
  public:
    //
    // Constructor
    //
    gtoa_eltop_relu1_params(
    ...
    inline gtoa_eltop_relu1_params() = default;
    inline gtoa_eltop_relu1_params(const gtoa_eltop_relu1_params&)  = default;
...
#include "./legacy/tensor_gtoa_eltop_relu1_legacy.hpp"

#include "tensor_gtoa_eltop_relu1_param_priv.hpp"
  };

  // include implementation specific inline functions
#include "tensor_gtoa_eltop_relu1_inline.hpp"
}
#endif // TENSOR_API_GTOA_ELTOP_RELU1_HPP_
