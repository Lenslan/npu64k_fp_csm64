...
#ifndef TENSOR_API_TENSOR_GTOA_RESCALE_HPP_
#define TENSOR_API_TENSOR_GTOA_RESCALE_HPP_
...
namespace tensor::v200 {
  ...
  // Tile specific parameters like coefficients and padding positions are not encoded
  // in the paramter object
  ///////////////////////////////////////////////////////////////////////////////////////////////
template<template<typename> class B = buffer_t>
class gtoa_rescale_params : public gtoa_act_params<B> {
 public:
    //
    // Constructor
    //
    ...
    inline gtoa_rescale_params() = default;
    inline gtoa_rescale_params(const gtoa_rescale_params&)  = default;
...
#include "./legacy/tensor_gtoa_rescale_legacy.hpp"

#include "tensor_api_impl/tensor_gtoa_rescale_param_priv.hpp"
};

  // include implementation specific inline functions
#include "tensor_api_impl/tensor_gtoa_rescale_inline.hpp"
}  // namespace tensor::v200
#endif  // TENSOR_API_TENSOR_GTOA_RESCALE_HPP_
