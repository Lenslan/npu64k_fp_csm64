...
/*
 * tensor_gtoa_eltop_relu6.hpp
 *
 * File defining a tensor level fused element-wise add and relu6 API base on the generic tensor operation API
 *
 */
...
#ifndef TENSOR_API_TENSOR_GTOA_ELTOP_RELU6_HPP_
#define TENSOR_API_TENSOR_GTOA_ELTOP_RELU6_HPP_


// include interface datatypes
#include "tensor_gtoa_eltop_act.hpp"  // NOLINT [build/include_subdir]
...
namespace tensor::v200 {
  ...
  class gtoa_eltop_relu6_params : public gtoa_eltop_act_params<B> {
  public:
    //
    // Constructor
    //
    gtoa_eltop_relu6_params(
    ...
    inline gtoa_eltop_relu6_params() = default;
    inline gtoa_eltop_relu6_params(const gtoa_eltop_relu6_params&)  = default;
    ...
    void param_enc(const tensor_t<prescale_t,1,xbuffer_t>&   prescale0,   // per channel 2b+6b prescale for scaling input accum
                   ...
                   const tensor_t<fp_e8m23_t,1,xbuffer_t>&   clipmax,     // per channel output quantization offset [Cout]
...
#include "./legacy/tensor_gtoa_eltop_relu6_legacy.hpp"

#include "tensor_gtoa_eltop_relu6_param_priv.hpp"  // NOLINT [build/include_subdir]
  };

  // include implementation specific inline functions
#include "tensor_gtoa_eltop_relu6_inline.hpp"      // NOLINT [build/include_subdir]
}   // namespace tensor::v200
#endif   // TENSOR_API_TENSOR_GTOA_ELTOP_RELU6_HPP_
