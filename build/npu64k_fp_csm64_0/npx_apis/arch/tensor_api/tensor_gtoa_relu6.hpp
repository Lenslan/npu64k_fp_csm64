...
#ifndef TENSOR_GTOA_RELU6_INCLUDED
#define TENSOR_GTOA_RELU6_INCLUDED
...
namespace tensor::v200 {
  ...
  class gtoa_relu6_params : public gtoa_act_params<B> {
  public:
    //
    // Constructor
    //
    ...
    inline gtoa_relu6_params() = default;
    inline gtoa_relu6_params(const gtoa_relu6_params&)  = default;
...
#include "./legacy/tensor_gtoa_relu6_legacy.hpp"

#include "tensor_gtoa_relu6_param_priv.hpp"
  };

  // include implementation specific inline function
#include "tensor_gtoa_relu6_inline.hpp"
}
#endif
