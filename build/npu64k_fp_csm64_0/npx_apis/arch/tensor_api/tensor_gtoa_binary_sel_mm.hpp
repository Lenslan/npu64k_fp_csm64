...
#ifndef TENSOR_API_TENSOR_GTOA_BINARY_SEL_MM_HPP_
#define TENSOR_API_TENSOR_GTOA_BINARY_SEL_MM_HPP_
...
class gtoa_binary_sel_mm_params : public gtoa_binary_params<B> {
 public:
  //
  // Constructor
  //
  // AM(32b) + AM(32b)/B/SR -> VM(8b/16b)
  gtoa_binary_sel_mm_params(
  ...
  gtoa_binary_sel_mm_params(
            ...
            bool                       fmi1dbli,      // 16b input feature-map 1
            act_bin_op_t               opi);          // binary operation to perform
  inline gtoa_binary_sel_mm_params() = default;
  inline gtoa_binary_sel_mm_params(const gtoa_binary_sel_mm_params&)  = default;

// include implementation specific private members
#include "./tensor_gtoa_binary_sel_mm_param_priv.hpp"
};

// include implementation specific inline functionsinclude "tensor_gtoa_binary_inline.hpp"
#include "./tensor_gtoa_binary_sel_mm_inline.hpp"
}  // namespace tensor::v200
#endif  // TENSOR_API_TENSOR_GTOA_BINARY_SEL_MM_HPP_
