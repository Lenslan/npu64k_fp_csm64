...
#ifndef TENSOR_GTOA_INTFP_INCLUDED
#define TENSOR_GTOA_INTFP_INCLUDED
...
namespace tensor::v200 {
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////
  //
  // Split integer and fraction part of FP32 float into INT16 and INT16, interleaved in group dimension
  //
  ///////////////////////////////////////////////////////////////////////////////////////////////
  template<template<typename> class B=buffer_t>
  class gtoa_intfp_params : public gtoa_params<B> {
  public:
    //
    // Constructor
    //
    // type parameterizable, intfp opcode
    gtoa_intfp_params(
                      aoffset_t                  noi,           // number output channels (not vectors)
                      const shape<3>&            oshpi          // output shape, indexed by spatial_axis_t
                      );
    inline gtoa_intfp_params() = default;
    inline gtoa_intfp_params(const gtoa_intfp_params&)  = default;
...
#include "tensor_gtoa_intfp_param_priv.hpp"
  };

  // include implementation specific inline functionsinclude "tensor_gtoa_intfp_inline.hpp"
#include "tensor_gtoa_intfp_inline.hpp"
}
#endif
