...
#ifndef TENSOR_API_GTOA_ELTOP_PLUT_HPP_
#define TENSOR_API_GTOA_ELTOP_PLUT_HPP_
...
namespace tensor::v200 {
  ...
  class gtoa_eltop_plut_params : public gtoa_eltop_act_params<B> {
  public:
    //
    // Constructor
    //
    ...
    inline gtoa_eltop_plut_params() = default;
    inline gtoa_eltop_plut_params(const gtoa_eltop_plut_params&)  = default;
...
#include "./legacy/tensor_gtoa_eltop_plut_legacy.hpp"

#include "tensor_gtoa_eltop_plut_param_priv.hpp"
  };

  // include implementation specific inline functions
#include "tensor_gtoa_eltop_plut_inline.hpp"
}
#endif // TENSOR_API_GTOA_ELTOP_PLUT_HPP_
