...
/*
 * tensor_gtoa_eltop_relu.hpp
 *
 * File defining a tensor level fused element-wise add and relu API base on the generic tensor operation API
 *
 */
...
#ifndef TENSOR_API_GTOA_ELTOP_RELU_HPP_
#define TENSOR_API_GTOA_ELTOP_RELU_HPP_
...
namespace tensor::v200 {
  ...
  class gtoa_eltop_relu_params : public gtoa_eltop_act_params<B> {
  public:
    //
    // Constructor
    //
    gtoa_eltop_relu_params(
    ...
    inline gtoa_eltop_relu_params() = default;
    inline gtoa_eltop_relu_params(const gtoa_eltop_relu_params&)  = default;
...
#include "./legacy/tensor_gtoa_eltop_relu_legacy.hpp"

#include "tensor_gtoa_eltop_relu_param_priv.hpp"
  };

  // include implementation specific inline functions
#include "tensor_gtoa_eltop_relu_inline.hpp"
}
#endif // TENSOR_API_GTOA_ELTOP_RELU_HPP_
